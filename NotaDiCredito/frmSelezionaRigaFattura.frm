...
If frmMain.txtIDLetteraIntento.Value > 0 Then
    If Me.txtIDLetteraIntento.Value > 0 Then
        If frmMain.txtIDLetteraIntento.Value <> Me.txtIDLetteraIntento.Value Then
            MsgBox "La lettera d'intento utilizzata nel documento non è congruente con quella del documento selezionato.", vbCritical, "Validazione dati"
            Exit Sub
        End If
    End If
End If
...
If Me.chkRiportaTuttoDoc = vbUnchecked Then
    ...
    If frmMain.txtIDLetteraIntento.Value = 0 Then
        Rif_LetteraIntento = Me.txtIDLetteraIntento.Value
    End If
