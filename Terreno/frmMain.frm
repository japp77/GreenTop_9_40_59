...
Object = "{7A646BF1-D0C2-11D2-9207-00105AE04248}#8.0#0"; "DmtTown.OCX"
      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.TextBox Text1 
               ...
               Width           =   1935
            End
            Begin VB.CommandButton cmdMappa 
               Height          =   315
               Left            =   12000
               ...
               Width           =   375
            End
            Begin VB.TextBox txtDimensioneTerrenoEffettivaHA 
               ...
               Width           =   2055
            End
            Begin VB.TextBox txtDimensioneTerrenoHA 
               Alignment       =   1  'Right Justify
               Height          =   315
               Left            =   6600
               Locked          =   -1  'True
            ...
            Begin VB.TextBox txtAnnotazioni 
               ...
               Width           =   12255
            End
            Begin VB.TextBox txtEstremiTitolo 
               Height          =   315
               Left            =   2520
               MultiLine       =   -1  'True
               ScrollBars      =   2  'Vertical
            ...
            Begin DmtTown.Town Town 
               ...
               IDFirm          =   0
               HwndContainer   =   0
               PropComune      =   $"frmMain.frx":47F74
               PropCAP         =   $"frmMain.frx":47FAE
               PropProvincia   =   $"frmMain.frx":47FE8
            End
            Begin TabDlg.SSTab SSTab1 
               ...
               TabsPerRow      =   1
               TabHeight       =   520
               TabCaption(0)   =   "MAPPE CATASTALI"
               TabPicture(0)   =   "frmMain.frx":48027
               ...
               Tab(0).Control(9)=   "Label2(13)"
               Tab(0).Control(9).Enabled=   0   'False
               Tab(0).Control(10)=   "cboTitoloRighe"
               Tab(0).Control(10).Enabled=   0   'False
               Tab(0).Control(11)=   "txtSuperficieEffettivaMQ"
               Tab(0).Control(11).Enabled=   0   'False
               Tab(0).Control(12)=   "Check1"
               Tab(0).Control(12).Enabled=   0   'False
               Tab(0).Control(13)=   "Griglia"
               Tab(0).Control(13).Enabled=   0   'False
               Tab(0).Control(14)=   "txtSuperficieMQ"
               Tab(0).Control(14).Enabled=   0   'False
               Tab(0).Control(15)=   "txtSuperficieHA"
               Tab(0).Control(15).Enabled=   0   'False
               Tab(0).Control(16)=   "txtParticellaCatastale"
               Tab(0).Control(16).Enabled=   0   'False
               Tab(0).Control(17)=   "txtMappaCatastale"
               Tab(0).Control(17).Enabled=   0   'False
               Tab(0).Control(18)=   "txtFoglioCatastale"
               Tab(0).Control(18).Enabled=   0   'False
               Tab(0).Control(19)=   "cmdNuovo_Quadratura"
               Tab(0).Control(19).Enabled=   0   'False
               Tab(0).Control(20)=   "cmdSalva_Quadratura"
               Tab(0).Control(20).Enabled=   0   'False
               Tab(0).Control(21)=   "cmdElimina_Quadratura"
               Tab(0).Control(21).Enabled=   0   'False
               Tab(0).Control(22)=   "txtSubPerticella"
               Tab(0).Control(22).Enabled=   0   'False
               Tab(0).Control(23)=   "txtSuperficieEffettivaHA"
               Tab(0).Control(23).Enabled=   0   'False
               Tab(0).Control(24)=   "chkAnnullato"
               ...
               Begin VB.CheckBox chkAnnullato 
                  ...
                  Width           =   1335
               End
               Begin VB.TextBox txtSuperficieEffettivaHA 
                  Alignment       =   1  'Right Justify
                  Enabled         =   0   'False
                  Height          =   315
                  Left            =   1680
                  ...
                  Width           =   1815
               End
               Begin VB.TextBox txtSubPerticella 
                  Height          =   315
                  Left            =   5040
                  TabIndex        =   14
                  Top             =   600
               ...
               Begin VB.CommandButton cmdNuovo_Quadratura 
                  ...
                  Width           =   1455
               End
               Begin VB.TextBox txtFoglioCatastale 
                  Height          =   315
                  Left            =   120
                  TabIndex        =   11
                  Top             =   600
                  Width           =   1575
               End
               Begin VB.TextBox txtMappaCatastale 
                  Height          =   315
                  Left            =   1800
                  TabIndex        =   12
                  Top             =   600
                  Width           =   1575
               End
               Begin VB.TextBox txtParticellaCatastale 
                  Height          =   315
                  Left            =   3480
                  TabIndex        =   13
                  Top             =   600
               ...
               Begin VB.CheckBox Check1 
                  ...
                  Width           =   3015
               End
               Begin DMTEDITNUMLib.dmtNumber txtSuperficieEffettivaMQ 
                  Height          =   315
                  Left            =   120
                  TabIndex        =   15
                  Top             =   1200
                  ...
                  UseSeparator    =   -1  'True
               End
               Begin DMTDataCmb.DMTCombo cboTitoloRighe 
                  Height          =   315
                  Left            =   7080
                  TabIndex        =   52
                  Top             =   1200
            ...
            Begin DmtCodDescCtl.DmtCodDesc CDSocio 
               ...
               BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               PropDescrizione =   $"frmMain.frx":48091
               BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               MenuFunctions   =   $"frmMain.frx":480E1
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  Name            =   "Verdana"
                  Size            =   8.25
                  Charset         =   0
               ...
               Enabled         =   0   'False
            End
            Begin DMTEDITNUMLib.dmtNumber txtDimensioneTerrenoMQ 
               Height          =   315
               Left            =   4440
               TabIndex        =   9
               Top             =   3840
               ...
               UseSeparator    =   -1  'True
            End
            Begin DMTEDITNUMLib.dmtNumber txtDimensioneTerrenoEffettivaMQ 
               Height          =   315
               Left            =   120
               TabIndex        =   7
               Top             =   3840
            ...
            End
            Begin VB.Label Label2 
               Caption         =   "Sup. coltivabile in M.q."
               Height          =   255
               Index           =   7
               Left            =   4440
               TabIndex        =   46
            ...
            End
            Begin VB.Label Label2 
               Caption         =   "Sup. coltivabile in H.a."
               Height          =   255
               Index           =   6
               Left            =   6600
               TabIndex        =   45
...
Private Const CAMPO_PER_CAPTION = "Terreno"
...
Private Sub CreateFormFields()
    ...
    'Terreno
    Set Field = New FormField
    Set Field.Control = Me.txtTerreno
    Field.Name = "Terreno"
    Field.Visible = True
    Me.txtTerreno.Tag = Field.Name
    m_FormFields.Add Field
    
    'IDComune
    Set Field = New FormField
    Set Field.Control = Me.Town
    Field.Name = "IDComune"
    Field.Visible = True
    Me.Town.Tag = Field.Name
    m_FormFields.Add Field
    
    'Cap                                <--- notare il trattamento del campo CAP (vedere RefreshFormFields)
    Set Field = New FormField
    Set Field.Control = Me.Town
    Field.Name = "Cap"
    Field.Visible = True
'    Me.DmtTWContact.Tag = Field.Name   <-- qui Tag non serve
    m_FormFields.Add Field
    ...
    'Titolo
    Set Field = New FormField
    Set Field.Control = Me.cboTitolo
    Field.Name = "IDRV_PO01_Titolo"
    Field.Visible = True
    Me.cboTitolo.Tag = Field.Name
    m_FormFields.Add Field

    'Estremi del titolo
    Set Field = New FormField
    Set Field.Control = Me.txtEstremiTitolo
    Field.Name = "EstremiTitolo"
    Field.Visible = True
    Me.txtEstremiTitolo.Tag = Field.Name
    m_FormFields.Add Field
    ...
    'DimensioneColtivabileMQ
    Set Field = New FormField
    Set Field.Control = Me.txtDimensioneTerrenoMQ
    Field.Name = "DimensioneColtivabileMQ"
    Field.Visible = True
    Me.txtDimensioneTerrenoMQ.Tag = Field.Name
    m_FormFields.Add Field

   'DimensioneColtivabileHA
    Set Field = New FormField
    Set Field.Control = Me.txtDimensioneTerrenoHA
    Field.Name = "DimensioneColtivabileHA"
    Field.Visible = True
    Me.txtDimensioneTerrenoHA.Tag = Field.Name
    m_FormFields.Add Field

    'DimensioneEffettivaMQ
    Set Field = New FormField
    Set Field.Control = Me.txtDimensioneTerrenoEffettivaMQ
    Field.Name = "DimensioneEffettivaMQ"
    Field.Visible = True
    Me.txtDimensioneTerrenoEffettivaMQ.Tag = Field.Name
    m_FormFields.Add Field

   'DimensioneEffettivaHA
    Set Field = New FormField
    Set Field.Control = Me.txtDimensioneTerrenoEffettivaHA
    Field.Name = "DimensioneEffettivaHA"
    Field.Visible = True
    Me.txtDimensioneTerrenoEffettivaHA.Tag = Field.Name
    m_FormFields.Add Field
    
   'RV_POIDFeedentity
    Set Field = New FormField
    Set Field.Control = Me.Text1
    Field.Name = "RV_POIDFeedentity"
    Field.Visible = True
...
'**************************SOTTO DOCUMENTO DELLA QUADRATURA*******************************
    ...
    Set m_DocumentsLink = m_Document.AddDocumentsLink("RV_PO01_TerrenoRighe")
    
    'Impostazioni dell'oggetto DocumentsLink
    m_DocumentsLink.EnableRefreshLinks = True '<-- Abilita il refresh dei campi collegati
    m_DocumentsLink.PrimaryKey = "IDRV_PO01_TerrenoRighe" '<-- Specifica il campo chiave primaria
   
    'Crea un Link LEFT JOIN sulla tabella Articolo
    Set NewLink = m_DocumentsLink.AddLink("IDRV_PO01_Titolo", "RV_PO01_Titolo", ltLeft, "IDRV_PO01_Titolo")
    NewLink.AddLinkColumn "Titolo"
...
Private Sub CreateBrowserConditions()
    ...
    '            Set Cond = BrwMain.Conditions.Add(.Name, .Name, m_DocType.TableName, False, False, False, ConditionType(.DBType))
                ...
                'Set Cond = BrwMain.Conditions.Add("Terreno", "Terreno", m_DocType.TableName, False, False, False, ConditionType(.DBType))
                'Set Cond = BrwMain.Conditions.Add("Comune", "Comune", m_DocType.TableName, False, False, False, ConditionType(.DBType))
                    'Cond.RangeEnabled = True
                Set Cond = BrwMain.Conditions.Add("Anagrafica", "Socio/Fornitore", m_DocType.TableName, True, False, , dgCondTypeText)
                Set Cond = BrwMain.Conditions.Add("Terreno", "Terreno", m_DocType.TableName, False, False, , dgCondTypeText)
                Set Cond = BrwMain.Conditions.Add("Comune", "Comune", m_DocType.TableName, True, False, , dgCondTypeText)
                Set Cond = BrwMain.Conditions.Add("RV_POIDFeedentity", "Identificativo Feed", m_DocType.TableName, False, False, , dgCondTypeText)
                Set Cond = BrwMain.Conditions.Add("IDRV_PO01_Titolo", "Titolo", m_DocType.TableName, , , , dgCondTypeComboDB)
                    Cond.RecordSource = "SELECT * FROM RV_PO01_Titolo"
                    Cond.DisplayField = "Titolo"
                    Cond.KeyField = "IDRV_PO01_Titolo"
...
'SETTARE LE GRIGLIE DEI SOTTODOCUMENTI
    ...
    If Me.Griglia.ColumnsHeader.Count = 0 Then
        With Me.Griglia.ColumnsHeader
            .Add "IDRV_PO01_TerrenoRighe", "IDRV_PO01_TerrenoRighe", dbInteger
            .Add "IDRV_PO01_TerrenoTesta", "IDRV_PO01_TerrenoTesta", dbInteger
            .Add "MappaCatastale", "Mappa catastale", dgchar, True, 2000, 0, True, True, False
            .Add "FoglioCatastale", "Foglio catastale", dgchar, True, 2000, 0, True, True, False
            .Add "ParticellaCatastale", "Particella", dgchar, True, 2000, 0, True, True, False
            .Add "SubCatastale", "Sub", dgchar, True, 1500, 0, True, True, False
            Set cl = .Add("SuperficieHA", "Sup. HA", dgchar, True, 1000, 0, True, True, False)
            Set cl = .Add("SuperficieMQ", "Sup. MQ", dgDouble, True, 1000, 0, True, True, False)
            ...
            .Add "Titolo", "Titolo", dgchar, True, 1000, 0, True, True, False
            .Add "Annullato", "Annullato", dgBoolean, True, 1000, dgAligncenter
            .Add "RV_POIDFeedentity", "ID Feed", dgchar, True, 1000, 0, True, True, False
        End With
    End If
...
'''''''''''''''''''''''''CONTROLLI STANDARD''''''''''''''''''''''''''''''''''''
    ...
    With Me.Town
        Set .Database = m_App.Database.Connection  '<-- notare la connessione dmtoledblib.ADOConnection
    ...
    With Me.cboTitolo
        ...
        .AddFieldKey "IDRV_PO01_Titolo"
        .DisplayField = "Titolo"
        .SQL = "SELECT * FROM RV_PO01_Titolo ORDER BY Titolo"
        .Fill
    End With

      
    'Titolo
    With Me.cboTitoloRighe
        Set .Database = m_App.Database.Connection
        .AddFieldKey "IDRV_PO01_Titolo"
        .DisplayField = "Titolo"
        .SQL = "SELECT * FROM RV_PO01_Titolo ORDER BY Titolo"
    ...
    For Each Field In m_Document.Fields
        ...
        If Not Field.PrimaryKey Then
            ...
            Else
                ...
                End If
                If Field.Name = "DataUltimaModifica" Then
                    Field.Value = Now
                End If
            End If
        End If
...
Dim DocLink As DmtDocManLib.DocumentsLink
    ...
    If fnMsgQuestion(gResource.GetCustomizedMessage(MESS_QUERYREMOVE), m_App.FunctionName) = vbYes Then
        ...
        If GET_CONTROLLO_MOV_TERRENO(fnNotNullN(m_Document(m_Document.PrimaryKey).Value)) = True Then
            MsgBox "Impossibile eliminare il terreno poichè è stato utilizzato nella configurazione di uno schema del socio", vbInformation, TheApp.FunctionName
            Exit Sub
        End If
        'rif16
                        
        If GET_CONTROLLO_MOV_TERRENO_PARTICELLE(fnNotNullN(m_Document(m_Document.PrimaryKey).Value)) = True Then
            MsgBox "Impossibile eliminare il terreno poichè alcune particelle sono state utilizzate nella configurazione delle serre del socio", vbInformation, TheApp.FunctionName
            Exit Sub
        End If
...
Dim Testo As String
    ...
    If GET_CONTROLLO_MOV_TERRENO_RIGA(fnNotNullN(m_DocumentsLink(m_DocumentsLink.PrimaryKey).Value)) = True Then
        MsgBox "La particella è stata utilizzata per configurare le serre del socio", vbInformation, "Impossibile eliminare"
        Exit Sub
    End If
    ...
    GET_SOMMA_TOTALE_TERRENO fnNotNullN(m_Document(m_Document.PrimaryKey).Value)
...
Dim FormattaIndirizzo() As String
Dim I As Long
Dim FormattaSplitIndirizzo  As String
Dim IndirizzoWeb As String
Dim IndirizzoFormattato As String

IndirizzoFormattato = Replace(Me.txtIndirizzo.Text, "-", " ")
IndirizzoFormattato = Replace(IndirizzoFormattato, "+", " ")
'IndirizzoFormattato = Replace(IndirizzoFormattato, "'", " ")

FormattaIndirizzo = Split(IndirizzoFormattato, " ")

IndirizzoWeb = ""
For I = 0 To UBound(FormattaIndirizzo)
    
    If Len(Trim(FormattaIndirizzo(I))) > 0 Then
        
        'FormattaSplitIndirizzo = Replace(FormattaIndirizzo(I), "-", "")
        'FormattaSplitIndirizzo = Replace(FormattaSplitIndirizzo, "+", "")
        
        If Len(IndirizzoWeb) > 0 Then
            IndirizzoWeb = IndirizzoWeb & "+"
        End If
        IndirizzoWeb = IndirizzoWeb & FormattaIndirizzo(I)
        
    End If
Next

If Me.Town.CityID > 0 Then
    IndirizzoWeb = IndirizzoWeb & "+" & Me.Town.City
End If
If Len(Trim(Me.Town.Zip)) > 0 Then
    IndirizzoWeb = IndirizzoWeb & "+" & Trim(Me.Town.Zip)
End If

Indirizzo = "http://www.map-generator.net/map.php?name=&address="
Indirizzo = Indirizzo & IndirizzoWeb & "&width=800&height=600&maptype=hybrid&zoom=16&t=1296051423"


X = ShellExecute(Scr_hDC, "Open", Indirizzo, "", Indirizzo, SW_SHOWNORMAL)
...
Private Sub cmdNuovo_Quadratura_Click()
    ...
    If fnNotNullN(m_Document(m_Document.PrimaryKey).Value) <= 0 Then
        MsgBox "Salvare il documento prima di inserire le righe", vbInformation, TheApp.FunctionName
        Exit Sub
    End If
...
On Error GoTo ERR_cmdSalva_Quadratura_Click
    ...
    m_DocumentsLink("FoglioCatastale").Value = Me.txtFoglioCatastale.Text
    m_DocumentsLink("MappaCatastale").Value = Trim(Me.txtMappaCatastale.Text)
    m_DocumentsLink("ParticellaCatastale").Value = Me.txtParticellaCatastale.Text
    m_DocumentsLink("ProprietaAffitto").Value = Me.Check1.Value
    m_DocumentsLink("SuperficieHA").Value = Me.txtSuperficieHA.Text
    m_DocumentsLink("SuperficieMQ").Value = Me.txtSuperficieMQ.Value
    m_DocumentsLink("SubCatastale").Value = Me.txtSubPerticella.Text
    m_DocumentsLink("SuperficieEffettivaHA").Value = Me.txtSuperficieEffettivaHA.Text
    m_DocumentsLink("SuperficieEffettivaMQ").Value = Me.txtSuperficieEffettivaMQ.Value
    m_DocumentsLink("IDRV_PO01_Titolo").Value = Me.cboTitoloRighe.CurrentID
    m_DocumentsLink("Annullato").Value = Me.chkAnnullato.Value
    m_DocumentsLink("RV_POIDFeedentity").Value = Me.Text2.Text
    
    If m_DocumentsLink(m_DocumentsLink.PrimaryKey).Value <= 0 Then
        m_DocumentsLink("GuidID").Value = GetGUID
    End If
...
Private Sub Command1_Click()
    Me.Text2.Locked = Not (Me.Text2.Locked)
End Sub

Private Sub Command2_Click()
    Me.Text1.Locked = Not (Me.Text1.Locked)
End Sub
...
Private Sub m_DocumentsLink_OnReposition()
    ...
    If Not (m_DocumentsLink.BOF And m_DocumentsLink.EOF) Then
        ...
        Me.txtFoglioCatastale.Text = fnNotNull(m_DocumentsLink("FoglioCatastale").Value)
        Me.txtMappaCatastale.Text = fnNotNull(m_DocumentsLink("MappaCatastale").Value)
        Me.txtParticellaCatastale.Text = fnNotNull(m_DocumentsLink("ParticellaCatastale").Value)
        Me.Check1.Value = fnNotNullN(Abs(m_DocumentsLink("ProprietaAffitto")))
        Me.txtSuperficieHA.Text = fnNotNull(m_DocumentsLink("SuperficieHA").Value)
        Me.txtSuperficieMQ.Value = fnNotNullN(m_DocumentsLink("SuperficieMQ").Value)
        Me.txtSubPerticella.Text = fnNotNull(m_DocumentsLink("SubCatastale").Value)
        Me.txtSuperficieEffettivaHA.Text = fnNotNull(m_DocumentsLink("SuperficieEffettivaHA").Value)
        Me.txtSuperficieEffettivaMQ.Value = fnNotNullN(m_DocumentsLink("SuperficieEffettivaMQ").Value)
        Me.cboTitoloRighe.WriteOn fnNotNullN(m_DocumentsLink("IDRV_PO01_Titolo").Value)
        Me.chkAnnullato.Value = Abs(fnNotNullN(m_DocumentsLink("Annullato")))
        Me.Text2.Text = fnNotNull(m_DocumentsLink("RV_POIDFeedentity").Value)
        bValue = True
    ...
    Else
        ...
        '---------------------------------------------
        Me.txtFoglioCatastale.Text = ""
        Me.txtMappaCatastale.Text = ""
        Me.txtParticellaCatastale.Text = ""
        Me.Check1.Value = 0
        Me.txtSuperficieHA.Text = ""
        Me.txtSuperficieMQ.Value = ""
        Me.txtSubPerticella.Text = ""
        Me.txtSuperficieEffettivaHA.Text = ""
        Me.txtSuperficieEffettivaMQ.Value = 0
        Me.cboTitoloRighe.WriteOn 0
        Me.chkAnnullato.Value = 0
        Me.Text2.Text = ""
        bValue = False
        
    End If
    
        Me.txtFoglioCatastale.Enabled = bValue
        Me.txtMappaCatastale.Enabled = bValue
        Me.txtParticellaCatastale.Enabled = bValue
        Me.Check1.Enabled = bValue
        Me.txtSuperficieHA.Enabled = bValue
        Me.txtSuperficieMQ.Enabled = bValue
        Me.txtSubPerticella.Enabled = bValue
        Me.txtSuperficieEffettivaHA.Enabled = bValue
        Me.txtSuperficieEffettivaMQ.Enabled = bValue
        Me.cboTitoloRighe.Enabled = bValue
        Me.chkAnnullato.Enabled = bValue
...
Private Sub txtDimensioneTerrenoEffettivaHA_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtDimensioneTerrenoEffettivaMQ_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtDimensioneTerrenoEffettivaMQ_LostFocus()
Dim I As Integer
...
Dim Valore As Long
Valore = Me.txtDimensioneTerrenoEffettivaMQ.Value
...
For I = 1 To Len(X)
    ...
    End If
Next
Me.txtDimensioneTerrenoEffettivaHA.Text = J
End Sub

Private Sub txtDimensioneTerrenoHA_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtDimensioneTerrenoMQ_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtDimensioneTerrenoMQ_LostFocus()
Dim I As Integer
Dim X As String 'Stringa da formattare
Dim J As String '
Dim Ris As String
...
Valore = Me.txtDimensioneTerrenoMQ.Value
...
For I = 1 To Len(X)
    ...
    End If
Next
Me.txtDimensioneTerrenoHA.Text = J
End Sub

Private Sub txtEstremiTitolo_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
...
Private Sub txtSuperficieEffettivaMQ_Change()
On Error Resume Next
    If fnNotNullN(m_DocumentsLink(m_DocumentsLink.PrimaryKey).Value) <= 0 Then
        Me.txtSuperficieMQ.Value = Me.txtSuperficieEffettivaMQ.Value
    End If
End Sub
Private Sub txtSuperficieEffettivaMQ_LostFocus()
Dim I As Integer
Dim X As String 'Stringa da formattare
Dim J As String '
Dim Ris As String
...
Dim Rimanenza As Integer
Dim Valore As Long
Valore = Me.txtSuperficieEffettivaMQ.Value
...
For I = 1 To Len(X)
    ...
    End If
Next
Me.txtSuperficieEffettivaHA.Text = J
End Sub
...
Private Sub EnableDOMActivitiesItems()
    ...
    ActivityBox.Redraw = True
End Sub
Private Sub GET_SOMMA_TOTALE_TERRENO(IDTerrenoTesta As Long)
On Error GoTo ERR_GET_SOMMA_TOTALE_TERRENO
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

sSQL = "SELECT Sum(SuperficieMQ) AS SommaSuperficieMQ, "
sSQL = sSQL & "Sum(SuperficieEffettivaMQ) AS SommaSuperficieEffettivaMQ "
sSQL = sSQL & "FROM RV_PO01_TerrenoRighe "
sSQL = sSQL & "WHERE IDRV_PO01_TerrenoTesta=" & IDTerrenoTesta
sSQL = sSQL & " AND Annullato=0"

Set rs = Cn.OpenResultset(sSQL)

If rs.EOF Then
    Me.txtDimensioneTerrenoMQ.Value = 0
    Me.txtDimensioneTerrenoEffettivaMQ.Value = 0
Else
    Me.txtDimensioneTerrenoMQ.Value = fnNotNullN(rs!SommaSuperficieMQ)
    Me.txtDimensioneTerrenoEffettivaMQ.Value = fnNotNullN(rs!SommaSuperficieEffettivaMQ)
End If

rs.CloseResultset
Set rs = Nothing

txtDimensioneTerrenoMQ_LostFocus
txtDimensioneTerrenoEffettivaMQ_LostFocus
Exit Sub
ERR_GET_SOMMA_TOTALE_TERRENO:
    MsgBox Err.Description, vbCritical, "GET_SOMMA_TOTALE_TERRENO"
End Sub
Private Function GET_CONTROLLO_MOV_TERRENO(IDTerreno As Long) As Boolean
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

sSQL = "SELECT * FROM RV_PO01_SettoreTerreni "
sSQL = sSQL & "WHERE IDRV_PO01_TerrenoTesta=" & IDTerreno

Set rs = Cn.OpenResultset(sSQL)

If rs.EOF Then
    GET_CONTROLLO_MOV_TERRENO = False
Else
    GET_CONTROLLO_MOV_TERRENO = True
End If

rs.CloseResultset
Set rs = Nothing
End Function
Private Function GET_CONTROLLO_MOV_TERRENO_RIGA(IDTerrenoRiga As Long) As Boolean
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

sSQL = "SELECT * FROM RV_PO01_SerraRighe "
sSQL = sSQL & "WHERE IDRV_PO01_TerrenoRighe=" & IDTerrenoRiga

Set rs = Cn.OpenResultset(sSQL)

If rs.EOF Then
    GET_CONTROLLO_MOV_TERRENO_RIGA = False
Else
    GET_CONTROLLO_MOV_TERRENO_RIGA = True
End If

rs.CloseResultset
Set rs = Nothing
End Function
Private Function GET_CONTROLLO_MOV_TERRENO_PARTICELLE(IDTerreno As Long) As Boolean
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

GET_CONTROLLO_MOV_TERRENO_PARTICELLE = False

sSQL = "SELECT * FROM RV_PO01_TerrenoRighe "
sSQL = sSQL & "WHERE IDRV_PO01_TerrenoTesta=" & IDTerreno

Set rs = Cn.OpenResultset(sSQL)

While Not rs.EOF
    If GET_CONTROLLO_MOV_TERRENO_PARTICELLE = False Then
        GET_CONTROLLO_MOV_TERRENO_PARTICELLE = GET_CONTROLLO_MOV_TERRENO_RIGA(fnNotNullN(rs!IDRV_PO01_TerrenoRighe))
    End If
rs.MoveNext
Wend
...
Set rs = Nothing
End Function
Private Function GET_ESISTENZA_COLLEGAMENTI(IDTerreno As Long) As Boolean
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

'CONTROLLO NELLO SCHEMA
sSQL = "SELECT * FROM RV_PO01_SettoreTerreni "
sSQL = sSQL & "WHERE IDRV_PO01_TerrenoTesta=" & IDTerreno
...
If rs.EOF Then
    GET_ESISTENZA_COLLEGAMENTI = False
Else
    GET_ESISTENZA_COLLEGAMENTI = True
End If

rs.CloseResultset
Set rs = Nothing

If GET_ESISTENZA_COLLEGAMENTI = True Then Exit Function

'CONTROLLO NEGLI EVENTI
sSQL = "SELECT * FROM RV_PO50_Eventi "
sSQL = sSQL & "WHERE IDRV_PO01_TerrenoTesta=" & IDTerreno
...
'CONTROLLO DEI COLLEGAMENTI DELLE PARTICELLE''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
sSQL = "SELECT * FROM RV_PO01_TerrenoRighe "
sSQL = sSQL & "WHERE IDRV_PO01_TerrenoTesta=" & IDTerreno

Set rs = Cn.OpenResultset(sSQL)
While Not rs.EOF
    If GET_ESISTENZA_COLLEGAMENTI = False Then
        If GET_CONTROLLO_COLLEGAMENTI_PARTICELLA(fnNotNullN(rs!IDRV_PO01_TerrenoRighe)) = True Then
            GET_ESISTENZA_COLLEGAMENTI = True
        End If
    End If
rs.MoveNext
...
End Function
Private Function GET_CONTROLLO_COLLEGAMENTI_PARTICELLA(IDTerrenoRiga As Long) As Boolean
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

'CONTROLLO NELLE SERRE''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
sSQL = "SELECT * FROM RV_PO01_SerraRighe "
sSQL = sSQL & "WHERE IDRV_PO01_TerrenoRighe=" & IDTerrenoRiga
...
If rs.EOF Then
    GET_CONTROLLO_COLLEGAMENTI_PARTICELLA = False
Else
    GET_CONTROLLO_COLLEGAMENTI_PARTICELLA = True
End If
