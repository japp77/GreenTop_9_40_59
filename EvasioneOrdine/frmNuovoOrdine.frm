...
'FrmMain.txtDataPartenza.Value = Me.txtDataPartenza.Value
'FrmMain.txtDataOrdineCliente.Value = Me.txtDataOrdineCliente.Value
'FrmMain.txtNumeroOrdineCliente.Text = Me.txtNumeroOrdineCliente.Text
'FrmMain.txtAnnotazioniOrdine.Text = Me.txtAnnotazioniOrdine.Text
'FrmMain.txtAnnotazioniInterna.Text = Me.txtAnnotazioniInterna.Text
'FrmMain.txtDescrizioneRigaDoc.Text = Me.txtDescrizioneRigaDoc.Text
'FrmMain.cboLuogoPresaMerce.WriteOn Me.cboLuogoPresaMerce.CurrentID
'FrmMain.cboVettoreSuccessivo.WriteOn Me.cboVettoreSuccessivo.CurrentID
...
Set ObjDoc = New DmtDocs.cDocument
    ...
    With ObjDoc
        ...
        .Field "Link_Doc_magazzino", fnGetParametriMagazzino, "ValoriOggettoPerTipo" & fnGetHex(ObjDoc.IDTipoOggetto)
        ...
        If VarNumeroDoc > 0 Then
            LINK_ORDINE = fncTrovaDocumento(VarNumeroDoc)
        Else
            LINK_ORDINE = 0
        End If
...
Dim sSQL As String
    ...
    sSQL = "SELECT IDMagazzino_Vendita  FROM RV_POSchemaCoop "
    sSQL = sSQL & "WHERE ((IDFiliale=" & TheApp.Branch & ") "
    ...
    If rsEse.EOF = False Then
        ...
        fnGetParametriMagazzino = fnNotNullN(rsEse!IDMagazzino_Vendita)
    Else
...
Set oServices.Connection = CnDMT
