...
Begin VB.Form frmTrovaOrdinePadre 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "TROVA ORDINE PADRE"
   ClientHeight    =   10650
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   17550
   ...
   EndProperty
   Icon            =   "frmTrovaOrdinePadre.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   10650
   ...
   Begin VB.Frame Frame1 
      ...
      Begin DmtCodDescCtl.DmtCodDesc cdCliente 
         ...
         _ExtentX        =   8705
         _ExtentY        =   1085
         PropCodice      =   $"frmTrovaOrdinePadre.frx":4781A
         BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         PropDescrizione =   $"frmTrovaOrdinePadre.frx":47868
         BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MenuFunctions   =   $"frmTrovaOrdinePadre.frx":478BA
   ...
   End
End
Attribute VB_Name = "frmTrovaOrdinePadre"
...
sSQL = sSQL & "WHERE RV_POOrdineCompletato = 0 "
sSQL = sSQL & " AND IDAzienda=" & TheApp.IDFirm
sSQL = sSQL & " AND IDFiliale=" & TheApp.Branch
sSQL = sSQL & " AND RV_PONumeroListaPrelievo=1"
...
'    LINK_ORDINE_RIF = Me.GridOrdine.AllColumns("IDOggetto").Value
'    frmMain.txtIDOrdineCliente.Value = LINK_ORDINE_RIF
    ...
    LINK_ORDINE_PADRE_SEL = Me.GridOrdine.AllColumns("IDOggetto").Value
