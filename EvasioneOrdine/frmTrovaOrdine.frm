...
Dim Testo As String
    ...
    FrmMain.txtDataOrdine.Value = Me.GridOrdine.AllColumns("Doc_data").Value
    FrmMain.txtNumeroOrdine.Value = Me.GridOrdine.AllColumns("Doc_numero").Value
    FrmMain.cdCliente.Load Me.GridOrdine.AllColumns("Link_nom_anagrafica").Value
    FrmMain.txtDataOrdineCliente.Value = fnNotNullN(Me.GridOrdine.AllColumns("Doc_data_presso_nom").Value)
    FrmMain.txtNumeroOrdineCliente.Text = fnNotNull(Me.GridOrdine.AllColumns("Doc_numero_presso_nom").Value)
    FrmMain.txtAnnotazioniOrdine.Text = fnNotNull(Me.GridOrdine.AllColumns("Doc_annotazioni_variazio").Value)
    FrmMain.txtDataPartenza.Value = fnNotNullN(Me.GridOrdine.AllColumns("Doc_data_prevista_evasione").Value)
    FrmMain.txtAnnotazioniInterna.Text = fnNotNull(Me.GridOrdine.AllColumns("RV_POAnnotazioniInterna").Value)
    FrmMain.txtDescrizioneRigaDoc.Text = fnNotNull(Me.GridOrdine.AllColumns("RV_PODescrizioneCorpoDocEv").Value)
    FrmMain.cboLuogoPresaMerce.WriteOn fnNotNullN(Me.GridOrdine.AllColumns("RV_POIDLuogoPresaMerce").Value)
    FrmMain.cboVettoreSuccessivo.WriteOn fnNotNullN(Me.GridOrdine.AllColumns("RV_POIDTrasportatoreSuccessivo").Value)
    
    LINK_ORDINE = fnNotNullN(Me.GridOrdine.AllColumns("IDOggetto").Value)
    FrmMain.txtIDOrdine.Value = LINK_ORDINE
