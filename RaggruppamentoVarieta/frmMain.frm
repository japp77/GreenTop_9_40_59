      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Top             =   0
               Width           =   8295
               Begin VB.TextBox txtClassificazione 
                  BeginProperty Font 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
               ...
               Begin VB.Label Label1 
                  Caption         =   "Raggruppamento varieta"
                  BeginProperty Font 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
...
Private Const CAMPO_PER_CAPTION = "RaggruppamentoVarieta"
...
'******************** variabili progetto **************************
Private FlagCambioCliente  As Integer
...
Private Sub CreateFormFields()
    ...
    'RaggruppamentoVarieta
    Set Field = New FormField
    Set Field.Control = Me.txtClassificazione
    Field.Name = "RaggruppamentoVarieta"
    Field.Visible = True
    Me.txtClassificazione.Tag = Field.Name
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("RaggruppamentoVarieta", "Raggruppamento", m_DocType.TableName, False, False, False, dgCondTypeText)
...
Private Sub txtClassificazione_Change()
