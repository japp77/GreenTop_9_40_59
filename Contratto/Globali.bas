...
Public GG_DATA_SCADENZA As Long
...
Public DATA_SCADENZA_OBBLIGATORIA As Long

Public rsQuantitaPerSocio As ADODB.Recordset

Public IDArtDettaglioProgSEL As Long
Public IDValoriOggettoDettaglioSel As Long
Public ChangeDatiQtaPerSocio As Long
