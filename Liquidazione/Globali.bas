...
Public SBLOCCA_LIQ_COLL As Long



Public Link_CategoriaMerceologica As Long
Public Link_TipoLavorazione As Long
Public Valore_TrattenutaPerLavorazione As Double
Public Valore_TrattenutaGenerale As Double

Public Valore_TotaleLordoDocumento As Double
Public Valore_TotaleIvaDocumento As Double

Public LINK_LIQUIDAZIONE As Long
Public LINK_RIGA_PREZZO_MEDIO As Long
Public LINK_PERIODO_LIQUIDAZIONE As Long
Public LINK_LIQUIDAZIONE_COLL As Long

Public RIGHE_MODIFICATE As Long
'PARAMETRI DI LIQUIDAZIONE
Public CONFERMA_RIC_LIQ_VEND As Long

Public LINK_PAR_TRATT_AGG_RETURN As Long
Public CONFERMA_PAR_TRATT_AGG As Boolean
