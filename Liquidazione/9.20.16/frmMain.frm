      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin TabDlg.SSTab SSTab1 
               ...
               Tab(1).Control(0)=   "cmdNuovaTrattenuta"
               Tab(1).Control(1)=   "cmdSalvaTrattenuta"
               Tab(1).Control(2)=   "cmdEliminaTrattenuta"
               Tab(1).Control(2).Enabled=   0   'False
               Tab(1).Control(3)=   "txtNuovaTrattenuta"
               Tab(1).Control(4)=   "txtImportoNuovaTrattenuta"
               Tab(1).Control(5)=   "GrigliaNuoveTrattenute"
               Tab(1).Control(6)=   "cboTipoTrattenutaAggiuntiva"
               Tab(1).Control(7)=   "txtPercentualeTrattenuta"
               Tab(1).Control(8)=   "cboSegnoTrattenuta"
               Tab(1).Control(9)=   "cboTipoRicalcoloComm"
               Tab(1).Control(10)=   "Label4(30)"
               Tab(1).Control(11)=   "Label6(7)"
               Tab(1).Control(12)=   "Label6(6)"
               Tab(1).Control(13)=   "Label4(17)"
               Tab(1).Control(14)=   "Label5(0)"
               Tab(1).Control(15)=   "Label5(1)"
