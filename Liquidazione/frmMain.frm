      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.CommandButton Command3 
               ...
               Width           =   2535
            End
            Begin VB.TextBox txtLiqElaborata 
               Height          =   315
               Left            =   120
               Locked          =   -1  'True
               TabIndex        =   154
            ...
            Begin VB.Frame Frame1 
               ...
               Begin DMTEDITNUMLib.dmtCurrency txtTotaleTrattenuteConferimento 
                  ...
                  DecFinalZeros   =   -1  'True
               End
               Begin DMTEDITNUMLib.dmtCurrency txtNettoLiquidazioneColl 
                  Height          =   255
                  Left            =   120
                  TabIndex        =   156
                  Top             =   6480
                  ...
                  DecFinalZeros   =   -1  'True
               End
               Begin DMTEDITNUMLib.dmtCurrency txtDifferenzaLiqColl 
                  Height          =   255
                  Left            =   120
                  TabIndex        =   158
                  Top             =   7080
               ...
               End
               Begin VB.Label Label3 
                  Caption         =   "Importo di liquidazione coll."
                  Height          =   255
                  Index           =   10
                  Left            =   120
                  TabIndex        =   157
            ...
            Begin TabDlg.SSTab SSTab1 
               ...
               Tab(0).Control(28)=   "Label4(31)"
               Tab(0).Control(28).Enabled=   0   'False
               Tab(0).Control(29)=   "txtTrattPercLav2"
               Tab(0).Control(29).Enabled=   0   'False
               Tab(0).Control(30)=   "txtTrattPercLav1"
               Tab(0).Control(30).Enabled=   0   'False
               Tab(0).Control(31)=   "txtTrattValLav2"
               Tab(0).Control(31).Enabled=   0   'False
               Tab(0).Control(32)=   "txtTrattValLav1"
               Tab(0).Control(32).Enabled=   0   'False
               Tab(0).Control(33)=   "txtTrattPercGen2"
               Tab(0).Control(33).Enabled=   0   'False
               Tab(0).Control(34)=   "txtTrattPercGen1"
               Tab(0).Control(34).Enabled=   0   'False
               Tab(0).Control(35)=   "txtTrattValGen2"
               Tab(0).Control(35).Enabled=   0   'False
               Tab(0).Control(36)=   "txtTrattValGen1"
               Tab(0).Control(36).Enabled=   0   'False
               Tab(0).Control(37)=   "txtTrattenuteConferimento"
               Tab(0).Control(37).Enabled=   0   'False
               Tab(0).Control(38)=   "GrigliaTrattenuteEla"
               Tab(0).Control(38).Enabled=   0   'False
               Tab(0).Control(39)=   "txtQtaLavorata"
               Tab(0).Control(39).Enabled=   0   'False
               Tab(0).Control(40)=   "txtQtaQuadLav"
               Tab(0).Control(40).Enabled=   0   'False
               Tab(0).Control(41)=   "txtTotaleLavorata"
               Tab(0).Control(41).Enabled=   0   'False
               Tab(0).Control(42)=   "txtQtaVenduta"
               Tab(0).Control(42).Enabled=   0   'False
               Tab(0).Control(43)=   "txtImportoTotaleVenduto"
               Tab(0).Control(43).Enabled=   0   'False
               Tab(0).Control(44)=   "txtTotaleTrattenuta"
               Tab(0).Control(44).Enabled=   0   'False
               Tab(0).Control(45)=   "txtImportoUnitarioVenduto"
               Tab(0).Control(45).Enabled=   0   'False
               Tab(0).Control(46)=   "txtTrattenutaPerLavorazione"
               Tab(0).Control(46).Enabled=   0   'False
               Tab(0).Control(47)=   "txtTrattenuteGenerali"
               Tab(0).Control(47).Enabled=   0   'False
               Tab(0).Control(48)=   "cboTipoLavorazione"
               Tab(0).Control(48).Enabled=   0   'False
               Tab(0).Control(49)=   "txtDifferenza"
               Tab(0).Control(49).Enabled=   0   'False
               Tab(0).Control(50)=   "txtLottoLavorato"
               Tab(0).Control(50).Enabled=   0   'False
               Tab(0).Control(51)=   "txtArticoloLavorato"
               Tab(0).Control(51).Enabled=   0   'False
               Tab(0).Control(52)=   "txtQtaConferita"
               Tab(0).Control(52).Enabled=   0   'False
               Tab(0).Control(53)=   "cmdSalva"
               Tab(0).Control(53).Enabled=   0   'False
               Tab(0).Control(54)=   "cmdElimina"
               Tab(0).Control(54).Enabled=   0   'False
               Tab(0).Control(55)=   "txtLottoConferito"
               Tab(0).Control(55).Enabled=   0   'False
               Tab(0).Control(56)=   "txtArticoloConferito"
               Tab(0).Control(56).Enabled=   0   'False
               Tab(0).Control(57)=   "cboTipoPrezzoMedio"
               Tab(0).Control(57).Enabled=   0   'False
               Tab(0).Control(58)=   "cmdTipoPrezzoMedio"
               Tab(0).Control(58).Enabled=   0   'False
               Tab(0).Control(59)=   "txtOrigineDocumento"
               Tab(0).Control(59).Enabled=   0   'False
               Tab(0).Control(60)=   "Command1"
               Tab(0).Control(60).Enabled=   0   'False
               Tab(0).Control(61)=   "Command2"
               Tab(0).Control(61).Enabled=   0   'False
               Tab(0).Control(62)=   "txtArticoloMix"
               ...
               Tab(1).Control(1)=   "chkConfigTrattAgg"
               Tab(1).Control(1).Enabled=   0   'False
               Tab(1).Control(2)=   "cmdNuovaTrattenuta"
               Tab(1).Control(2).Enabled=   0   'False
               Tab(1).Control(3)=   "cmdSalvaTrattenuta"
               Tab(1).Control(3).Enabled=   0   'False
               Tab(1).Control(4)=   "cmdEliminaTrattenuta"
               Tab(1).Control(4).Enabled=   0   'False
               Tab(1).Control(5)=   "txtNuovaTrattenuta"
               Tab(1).Control(5).Enabled=   0   'False
               Tab(1).Control(6)=   "txtImportoNuovaTrattenuta"
               Tab(1).Control(6).Enabled=   0   'False
               Tab(1).Control(7)=   "GrigliaNuoveTrattenute"
               Tab(1).Control(7).Enabled=   0   'False
               Tab(1).Control(8)=   "cboTipoTrattenutaAggiuntiva"
               Tab(1).Control(8).Enabled=   0   'False
               Tab(1).Control(9)=   "txtPercentualeTrattenuta"
               Tab(1).Control(9).Enabled=   0   'False
               Tab(1).Control(10)=   "cboSegnoTrattenuta"
               Tab(1).Control(10).Enabled=   0   'False
               Tab(1).Control(11)=   "cboTipoRicalcoloComm"
               Tab(1).Control(11).Enabled=   0   'False
               Tab(1).Control(12)=   "cboCatTratt"
               Tab(1).Control(12).Enabled=   0   'False
               Tab(1).Control(13)=   "Label6(8)"
               Tab(1).Control(13).Enabled=   0   'False
               Tab(1).Control(14)=   "Label4(30)"
               Tab(1).Control(14).Enabled=   0   'False
               Tab(1).Control(15)=   "Label6(7)"
               Tab(1).Control(15).Enabled=   0   'False
               Tab(1).Control(16)=   "Label6(6)"
               Tab(1).Control(16).Enabled=   0   'False
               Tab(1).Control(17)=   "Label4(17)"
               Tab(1).Control(17).Enabled=   0   'False
               Tab(1).Control(18)=   "Label5(0)"
               Tab(1).Control(18).Enabled=   0   'False
               Tab(1).Control(19)=   "Label5(1)"
               Tab(1).Control(19).Enabled=   0   'False
               Tab(1).ControlCount=   20
               TabCaption(2)   =   "Righe in fattura"
               TabPicture(2)   =   "frmMain.frx":47A22
               Tab(2).ControlEnabled=   0   'False
               Tab(2).Control(0)=   "txtDescrizioneRigaFatt"
               Tab(2).Control(1)=   "cmdElimina_RigheFatt"
               Tab(2).Control(1).Enabled=   0   'False
               Tab(2).Control(2)=   "cmdSalva_RigheFatt"
               Tab(2).Control(3)=   "cmdNuovo_RigheFatt"
               Tab(2).Control(4)=   "txtCodiceConto"
               Tab(2).Control(4).Enabled=   0   'False
               Tab(2).Control(5)=   "txtDescrizioneConto"
               Tab(2).Control(5).Enabled=   0   'False
               Tab(2).Control(6)=   "txtQtaRigaFatt"
               Tab(2).Control(7)=   "txtImportoTotaleFatt"
               Tab(2).Control(8)=   "txtImportoUnitarioFatt"
               Tab(2).Control(9)=   "txtAliquotaIva"
               Tab(2).Control(10)=   "cboIva"
               Tab(2).Control(11)=   "GridRigheFatt"
               Tab(2).Control(12)=   "Label6(0)"
               Tab(2).Control(13)=   "Label6(1)"
               Tab(2).Control(14)=   "Label6(2)"
               Tab(2).Control(15)=   "Label6(3)"
               Tab(2).Control(16)=   "Label6(4)"
               Tab(2).Control(17)=   "lblPianodeiDeiConti(4)"
               Tab(2).Control(18)=   "Label6(5)"
               Tab(2).ControlCount=   19
               Begin VB.CommandButton Command5 
                  Caption         =   "Nuovo da config."
                  Height          =   495
                  Left            =   -57960
                  TabIndex        =   166
                  Top             =   3480
                  Width           =   2175
               End
               Begin VB.CheckBox chkConfigTrattAgg 
                  Caption         =   "Calcola percentuale su trattenute"
                  Enabled         =   0   'False
                  Height          =   255
                  Left            =   -74880
                  TabIndex        =   165
                  ...
                  Width           =   6375
               End
               Begin VB.TextBox txtArticoloMix 
                  Appearance      =   0  'Flat
                  BackColor       =   &H00FFFFFF&
                  ForeColor       =   &H00FF0000&
                  Height          =   315
               ...
               Begin DMTDataCmb.DMTCombo cboTipoRicalcoloComm 
                  ...
                  EndProperty
               End
               Begin DMTDataCmb.DMTCombo cboCatTratt 
                  Height          =   315
                  Left            =   -61560
                  TabIndex        =   37
                  Top             =   1140
            ...
            Begin VB.Label Label2 
               Caption         =   "Collegamento a liquidazione elaborata"
               Height          =   255
               Index           =   2
               Left            =   120
               TabIndex        =   155
...
Private Liquidazione_Trasf As Long
'******************************************************************************

Private LINK_TIPO_TRATT_AGG As Long
Private CALCOLA_SU_TRATTENUTE As Long
...
On Error GoTo ERR_ExecuteMenuCommand
...
Exit Sub
ERR_ExecuteMenuCommand:
    Screen.MousePointer = 0
    MsgBox Err.Description, vbCritical, "ExecuteMenuCommand"
...
Private Sub Start()
    ...
    'Connessione di tipo DMTADODBLib
        ...
        GET_PARAMETRI_LIQ_FILIALE TheApp.Branch
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("IDCategoriaLiquidazione", "Categoria liquidazione", m_DocType.TableName, False, False, , dgCondTypeComboDB)
        Cond.Indentation = 20
        Cond.RecordSource = "SELECT * FROM RV_POCategoriaLiquidazione"
        Cond.DisplayField = "CategoriaLiquidazione"
        Cond.KeyField = "IDRV_POCategoriaLiquidazione"
...
'SETTARE LE GRIGLIE DEI SOTTODOCUMENTI
    ...
    If Me.GrigliaTrattenuteEla.ColumnsHeader.Count = 0 Then
        With Me.GrigliaTrattenuteEla.ColumnsHeader
            .Add "IDRV_POLiquidazioneRigheEla", "IDRV_POLiquidazioneRigheEla", dgInteger, False, 500, dgAlignRight
            .Add "IDRV_POLiquidazione", "IDRV_POLiquidazione", dgInteger, False, 500, dgAlignRight
            .Add "IDRV_POLiquidazionePeriodo", "IDRV_POLiquidazionePeriodo", dgInteger, False, 500, dgAlignRight
            ...
            Set cl = .Add("QuantitaVenduta", "Q.tà Vend", dgDouble, True, 1500, dgAlignRight)
                ...
                cl.FormatOptions.FormatNumericDecimals = 5
                cl.FormatOptions.FormatNumericThousandSep = "."
            Set cl = .Add("ImportoUnitarioDaReg", "Imp. uni. reg.", dgCurrency, False, 1500, dgAlignRight)
                cl.FormatOptions.FormatNumericRegionalSettings = False
                cl.FormatOptions.UseFormatControlSettings = False
            ...
            Set cl = .Add("TrattenutaValorePreLiq2", "Tratt. pre liq. 2", dgCurrency, True, 1500, dgAlignRight)
                ...
                cl.FormatOptions.FormatNumericDecimals = 5
                cl.FormatOptions.FormatNumericThousandSep = "."
            .Add "IDArticoloMixVenduto", "IDArticoloMixVenduto", dgInteger, False, 500, dgAlignRight
            .Add "CodiceArticoloMixVenduto", "Cod. Art. MIX Vend.", dgchar, True, 1500, dgAlignleft, False
            .Add "DescrizioneArticoloMixVenduto", "Art. MIX vend.", dgchar, True, 2500, 0, True, True, False
            .Add "IDRV_POProcessoIVGammaRighe", "IDRV_POProcessoIVGammaRighe", dgInteger, False, 500, dgAlignRight
        End With
    End If
...
'''''''''''''''''''''''''CONTROLLI STANDARD''''''''''''''''''''''''''''''''''''
    ...
    With Me.cboCatMerc
        ...
        .SQL = "SELECT * FROM RV_POCategoriaLiquidazione"
        .Fill
    End With
    With Me.cboCatTratt
        Set .Database = TheApp.Database.Connection
        .AddFieldKey "IDRV_POCategoriaTrattenuteAggiuntive"
        .DisplayField = "CategoriaTrattenuteAggiuntive"
        .SQL = "SELECT * FROM RV_POCategoriaTrattenuteAggiuntive ORDER BY CategoriaTrattenuteAggiuntive"
        .Fill
    End With
End Sub
...
On Error GoTo ERR_OnDelete
    ...
    If Me.chkPassaggioInFatt.Value = vbChecked Then
        ...
        Exit Sub
    End If
    If ((Liquidazione_Trasf > 0) And (fnNotNullN(m_Document("IDRV_POLiquidazioneCollegata").Value) = 0)) Then
        MsgBox "Impossibile eliminare la liquidazione poichè risulta collegata ad una liquidazione trasformata", vbCritical, TheApp.FunctionName
        Exit Sub
    End If
...
''''''''''''''''''''''''''''''''''''''''''ELIMINAZIONE DATI'''''''''''''''''''''''''''''''''''''''''''''''''''''''
        ...
        If Liquidazione_Trasf > 0 Then
            sSQL = "UPDATE RV_POLiquidazione SET "
            sSQL = sSQL & "Ufficiale=1 "
            sSQL = sSQL & "WHERE IDRV_POLiquidazione=" & Liquidazione_Trasf
            Cn.Execute sSQL
        End If
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
        'Cancellazione
...
Private Sub cboTipoRicalcoloComm_Click()
    ...
    If (Me.chkConfigTrattAgg.Value = vbChecked) Then
        Me.txtPercentualeTrattenuta.Enabled = False
        Me.txtImportoNuovaTrattenuta.Enabled = False
    End If
...
If (Liquidazione_Trasf > 0) Then
    If (SBLOCCA_LIQ_COLL = 0) Then
        Testo = "ATTENZIONE!!!" & vbCrLf
        Testo = Testo & "La liquidazione è stata generata da un processo pertanto è impossibile modificare le righe"
...
Dim NumeroRecordSel As Long
    ...
    If (fnNotNullN(m_DocumentsLink1(m_DocumentsLink1.PrimaryKey)) <= 0) Then
        NumeroRecordSel = Me.GrigliaNuoveTrattenute.ListCount - 1
    Else
        NumeroRecordSel = Me.GrigliaNuoveTrattenute.ListIndex - 1
    End If
    ...
    m_DocumentsLink1("IDRV_POParametriTrattenuteAgg").Value = LINK_TIPO_TRATT_AGG
    m_DocumentsLink1("IDRV_POCategoriaTrattenuteAggiuntive").Value = Me.cboCatTratt.CurrentID
    m_DocumentsLink1("CalcolaSuTrattenute").Value = Me.chkConfigTrattAgg.Value
    m_DocumentsLink1.Save
    
    'm_DocumentsLink1.Move Me.GrigliaNuoveTrattenute.ListIndex - 1
        
    RICALCOLO_TRATT_AGG_SU_TRATT Me.txtTotaleTrattenute.Value, Me.txtTotaleTrattenuteGenerali.Value, Me.txtTotaleTrattenutePerLavorazioni.Value
    ...
    Else
        Me.txtNettoLiquidazione.Value = Me.txtTotaleLordoDocumento.Value - Me.txtTotaleTrattenute.Value - Me.txtTotaleTrattenuteAgg.Value - Me.txtTotaleTrattAggRiep.Value
    End If
    Me.txtDifferenzaLiqColl.Value = Me.txtNettoLiquidazione.Value - Me.txtNettoLiquidazioneColl.Value
    
    OnSave
    m_DocumentsLink1.Refresh
    m_DocumentsLink1.Move NumeroRecordSel
End Sub
Private Sub RICALCOLO_TRATT_AGG_SU_TRATT(TotaleTrattenute As Double, TotaleTrattenuteGen As Double, TotaleTrattenuteLav As Double)
Dim sSQL As String
Dim rs As ADODB.Recordset
Dim rsConfig As DmtOleDbLib.adoResultset
Dim rsConfigCat As DmtOleDbLib.adoResultset
...
While Not rs.EOF
    TotaleDocumento = 0
    sSQL = "SELECT * FROM RV_POParametriTrattenuteAggConfig "
    sSQL = sSQL & "WHERE IDRV_POParametriTrattenuteAgg=" & fnNotNullN(rs!IDRV_POParametriTrattenuteAgg)
    
    Set rsConfig = Cn.OpenResultset(sSQL)
    If Not rsConfig.EOF Then
        If (fnNotNullN(rsConfig!CalcolaSuTrattenutaTotale) = 1) Then
            TotaleDocumento = TotaleDocumento + TotaleTrattenute
        End If
        If (fnNotNullN(rsConfig!CalcolaSuTrattenutaGenerale) = 1) Then
            TotaleDocumento = TotaleDocumento + TotaleTrattenuteGen
        End If
        If (fnNotNullN(rsConfig!CalcolaSuTrattenutaLavorazione) = 1) Then
            TotaleDocumento = TotaleDocumento + TotaleTrattenuteLav
        End If
    End If
    TotaleDocumento = TotaleDocumento + GET_TOT_PER_CAT_TRATT(fnNotNullN(rs!IDRV_POParametriTrattenuteAgg), fnNotNullN(m_Document(m_Document.PrimaryKey).Value))
    
    rs!ImportoTrattenuta = (TotaleDocumento / 100) * fnNotNullN(rs!Percentuale)
    rs.Update
    
    
    rsConfig.CloseResultset
...
'sSQL = "SELECT RV_POLiquidazioneRighe.IDRV_POLiquidazioneRighe, RV_POLiquidazioneRighe.IDRV_POLiquidazione, RV_POLiquidazioneRighe.DescrizioneAggiuntiva, RV_POLiquidazioneRighe.ImportoTrattenuta, "
'sSQL = sSQL & "RV_POLiquidazioneRighe.Percentuale, RV_POLiquidazioneRighe.IDRV_POTipoTrattenutaAggiuntiva, RV_POLiquidazioneRighe.IDRV_POSegnoTrattenuta, RV_POLiquidazioneRighe.IDRV_POAnticipazioniSocioRighe,"
'sSQL = sSQL & "RV_POLiquidazioneRighe.IDRV_POAnticipazioniSocio, RV_POLiquidazioneRighe.IDUtenteInserimento, RV_POLiquidazioneRighe.DataInserimento, RV_POLiquidazioneRighe.NomePCInserimento,"
'sSQL = sSQL & "RV_POLiquidazioneRighe.NomeUtentePCInserimento, RV_POLiquidazioneRighe.IDUtenteModifica, RV_POLiquidazioneRighe.DataModifica, RV_POLiquidazioneRighe.NomePCModifica,"
'sSQL = sSQL & "RV_POLiquidazioneRighe.NomeUtentePCModifica, RV_POLiquidazioneRighe.IDRV_POTipoRicalcoloComm, RV_POLiquidazioneRighe.IDRV_POCategoriaTrattenuteAggiuntive,"
'sSQL = sSQL & "RV_POLiquidazioneRighe.IDRV_POParametriTrattenuteAgg , RV_POLiquidazioneRighe.CalcolaSuTrattenute, RV_POParametriTrattenuteAggConfig.CalcolaSuTrattenutaTotale, "
'sSQL = sSQL & "RV_POParametriTrattenuteAggConfig.CalcolaSuTrattenutaGenerale , RV_POParametriTrattenuteAggConfig.CalcolaSuTrattenutaLavorazione"
'sSQL = sSQL & " FROM RV_POLiquidazioneRighe INNER JOIN "
'sSQL = sSQL & " RV_POParametriTrattenuteAgg ON RV_POLiquidazioneRighe.IDRV_POParametriTrattenuteAgg = RV_POParametriTrattenuteAgg.IDRV_POParametriTrattenuteAgg INNER JOIN"
...
'sSQL = sSQL & " WHERE IDRV_POLiquidazione=" & fnNotNullN(m_Document(m_Document.PrimaryKey).Value)
'sSQL = sSQL & " AND RV_POLiquidazioneRighe.CalcolaSuTrattenute = 1"
'
'Set rs = New ADODB.Recordset
'
'
...
On Error GoTo ERR_Command3_Click
    If Liquidazione_Trasf = 0 Then Exit Sub
    
    LINK_LIQUIDAZIONE_COLL = Liquidazione_Trasf
    frmLiquidazioneColl.Show vbModal
Exit Sub
ERR_Command3_Click:
...
On Error GoTo ERR_Command3_Click
    ...
    LINK_LIQUIDAZIONE = fnNotNullN(m_Document(m_Document.PrimaryKey).Value)
    frmPrezziVeloci.Show vbModal
    
    If CONFERMA_RIC_LIQ_VEND = 1 Then
        m_DocumentsLink.Refresh
        RicalcolaTotaleLiquidazione
        OnSave
    End If
...
On Error GoTo ERR_Command5_Click
    LINK_LIQUIDAZIONE = fnNotNullN(m_Document(m_Document.PrimaryKey).Value)
    frmElencoTrattAgg.Show vbModal
    If (CONFERMA_PAR_TRATT_AGG = True) Then
        If (LINK_PAR_TRATT_AGG_RETURN > 0) Then
            SET_TRATTENUTA_AGG_SU_TRATT LINK_PAR_TRATT_AGG_RETURN
        End If
    End If
Exit Sub
ERR_Command5_Click:
    MsgBox Err.Description, vbCritical, "Command5_Click"
    
End Sub
Private Sub SET_TRATTENUTA_AGG_SU_TRATT(ID As Long)
On Error GoTo ERR_SET_TRATTENUTA_AGG_SU_TRATT
Dim rs As DmtOleDbLib.adoResultset
Dim sSQL As String

sSQL = "SELECT * FROM RV_POParametriTrattenuteAgg "
sSQL = sSQL & "WHERE IDRV_POParametriTrattenuteAgg=" & ID

Set rs = Cn.OpenResultset(sSQL)

If Not rs.EOF Then
    cmdNuovaTrattenuta_Click
    Me.txtNuovaTrattenuta.Text = fnNotNull(rs!DescrizioneTrattenutaAggiuntiva)
    Me.txtImportoNuovaTrattenuta.Value = 0
    Me.cboTipoTrattenutaAggiuntiva.WriteOn fnNotNullN(rs("IDRV_POTipoTrattenutaAggiuntiva").Value)
    Me.txtPercentualeTrattenuta.Value = fnNotNullN(rs("Percentuale").Value)
    Me.cboTipoRicalcoloComm.WriteOn 1
    Me.cboCatTratt.WriteOn fnNotNullN(rs("IDRV_POCategoriaTrattenuteAggiuntive").Value)
    LINK_TIPO_TRATT_AGG = fnNotNullN(rs("IDRV_POParametriTrattenuteAgg").Value)
    Me.chkConfigTrattAgg.Value = fnNotNullN(rs("CalcolaSuTrattenute").Value)
    cmdSalvaTrattenuta_Click
End If

rs.CloseResultset
Set rs = Nothing
Exit Sub
ERR_SET_TRATTENUTA_AGG_SU_TRATT:
    MsgBox Err.Description, vbCritical, "SET_TRATTENUTA_AGG_SU_TRATT"
End Sub
...
Private Sub GrigliaTrattenuteEla_Click()
...
'            End If
   ...
   'If Me.GrigliaFasiIntervento.ColumnsHeader.Count > 0 Then
    ...
    Me.cboCatMerc.WriteOn fnNotNullN(m_Document("IDCategoriaLiquidazione").Value)
    'rif11 end
    
    Liquidazione_Trasf = 0
    Me.chkUfficiale.Enabled = True
    Me.txtLiqElaborata.Text = ""
    Me.txtNettoLiquidazioneColl.Value = 0
    Label3(10).Visible = False
    Label3(11).Visible = False
    Me.txtNettoLiquidazioneColl.Visible = False
    Me.txtDifferenzaLiqColl.Visible = False
    
    If fnNotNullN(m_Document("IDRV_POLiquidazioneCollegata").Value) = 0 Then
        Liquidazione_Trasf = GET_LIQ_COLLEGATA(fnNotNullN(m_Document(m_Document.PrimaryKey).Value))
    Else
        'Liquidazione_Trasf = GET_LIQ_COLLEGATA(fnNotNullN(m_Document("IDRV_POLiquidazioneCollegata").Value))
        Liquidazione_Trasf = fnNotNullN(m_Document("IDRV_POLiquidazioneCollegata").Value)
    End If
    
    If Liquidazione_Trasf > 0 Then
        Me.chkUfficiale.Enabled = False
        Label3(10).Visible = True
        Label3(11).Visible = True
        Me.txtNettoLiquidazioneColl.Visible = True
        Me.txtDifferenzaLiqColl.Visible = True
        Me.txtLiqElaborata.Text = GET_DESCR_LIQ_COLL(Liquidazione_Trasf)
        Me.txtNettoLiquidazioneColl.Value = GET_IMPORTI_LIQ_COLL(Liquidazione_Trasf)
        Me.txtDifferenzaLiqColl.Value = Me.txtNettoLiquidazione.Value - Me.txtNettoLiquidazioneColl.Value
    End If
...
Private Sub m_DocumentsLink_OnReposition()
    ...
    If Not (m_DocumentsLink.BOF And m_DocumentsLink.EOF) Then
        ...
        Me.txtArticoloMix.Text = fnNotNull(m_DocumentsLink("DescrizioneArticoloMixVenduto").Value)
...
Private Sub m_DocumentsLink1_OnReposition()
    ...
    If Not (m_DocumentsLink1.BOF And m_DocumentsLink1.EOF) Then
        ...
        Me.cboCatTratt.WriteOn fnNotNullN(m_DocumentsLink1("IDRV_POCategoriaTrattenuteAggiuntive").Value)
        LINK_TIPO_TRATT_AGG = fnNotNullN(m_DocumentsLink1("IDRV_POParametriTrattenuteAgg").Value)
        Me.chkConfigTrattAgg.Value = fnNotNullN(m_DocumentsLink1("CalcolaSuTrattenute").Value)
        bValue = True
    Else
        ...
        Me.cboCatTratt.WriteOn 0
        LINK_TIPO_TRATT_AGG = 0
        Me.chkConfigTrattAgg.Value = vbUnchecked
        bValue = False
    End If
    ...
    Me.cboCatTratt.Enabled = bValue
    Me.txtPercentualeTrattenuta.Enabled = bValue
    Me.txtImportoNuovaTrattenuta.Enabled = bValue
    cboTipoRicalcoloComm_Click
    
    If (Me.chkConfigTrattAgg.Value = vbChecked) Then
        Me.txtNuovaTrattenuta.Enabled = bValue
        Me.cboTipoTrattenutaAggiuntiva.Enabled = False
        Me.cboTipoRicalcoloComm.Enabled = False
        Me.cboCatTratt.Enabled = False
        Me.txtPercentualeTrattenuta.Enabled = False
        Me.txtImportoNuovaTrattenuta.Enabled = False
    End If
...
Private Sub txtOggetto_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
Private Sub txtPercentualeTrattenuta_LostFocus()
Dim calcolaSuTratt As Boolean

    If (fnNotNullN(m_DocumentsLink1("IDRV_POParametriTrattenuteAgg").Value) = 0) Then
        If Me.txtTotaleDocumento.Value > 0 Then
            Me.txtImportoNuovaTrattenuta.Value = (Me.txtTotaleDocumento.Value / 100) * Me.txtPercentualeTrattenuta.Value
        End If
    Else
        calcolaSuTratt = GET_CALCOLA_TRATT(fnNotNullN(m_DocumentsLink1("IDRV_POParametriTrattenuteAgg").Value))
        If (calcolaSuTratt = False) Then
            If Me.txtTotaleDocumento.Value > 0 Then
                Me.txtImportoNuovaTrattenuta.Value = (Me.txtTotaleDocumento.Value / 100) * Me.txtPercentualeTrattenuta.Value
            End If
        Else
    ...
    End If
End Sub
Private Function GET_CALCOLA_TRATT(ID As Long) As Boolean
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

GET_CALCOLA_TRATT = False
...
sSQL = sSQL & " AND CalcolaSuTrattenute=1"
sSQL = sSQL & " AND RV_POParametriTrattenuteAgg.IDRV_POParametriTrattenuteAgg=" & ID

Set rs = Cn.OpenResultset(sSQL)

If Not rs.EOF Then
    If fnNotNullN(rs!CalcolaSuTrattenute) = 1 Then
        GET_CALCOLA_TRATT = False
    End If
End If
...
On Error GoTo ERR_GET_PARAMETRI_LIQUIDAZIONE
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
...
Exit Sub
ERR_GET_PARAMETRI_LIQUIDAZIONE:
    MsgBox Err.Description, vbCritical, "GET_PARAMETRI_LIQUIDAZIONE"
End Sub
...
Dim TotaleDocumento As Double
Dim TotaleTrattenutaPerLavorazione As Double
Dim TotaleTrattenutaPerConferimento As Double
Dim TotaleTrattenutaGenerale As Double
Dim TotaleTrattenutaPerSocio  As Double
Dim TotaleImportoLordo As Double
Dim TotaleTrattenute As Double
...
'    Me.txtTotaleTrattenuteAgg.Value = 0
    ...
    RICALCOLO_NUOVE_TRATTENUTA fnNotNullN(m_Document(m_Document.PrimaryKey).Value), TotaleDocumento
    RICALCOLO_NUOVE_TRATTENUTA fnNotNullN(m_Document(m_Document.PrimaryKey).Value), TotaleDocumento, 2, TotaleTrattenute, TotaleTrattenutaGenerale, TotaleTrattenutaPerLavorazione
    Me.txtTotaleTrattenuteAgg.Value = GET_TOTALE_TRATTENUTA_AGGIUNTIVA(fnNotNullN(m_Document(m_Document.PrimaryKey)), 1)
    Me.txtTotaleTrattAggRiep.Value = GET_TOTALE_TRATTENUTA_AGGIUNTIVA(fnNotNullN(m_Document(m_Document.PrimaryKey)), 2)
    

Else
'    Me.txtTotaleDocumento.Value = rs!TotaleImponibile
'    Me.txtTotaleIvaDocumento.Value = rs!TotaleImposta
'    Me.txtTotaleLordoDocumento.Value = rs!TotaleDocumento
'    Me.txtTotaleTrattenuteConferimento.Value = rs!TotaleTrattenutaConferimento
'    Me.txtTotaleTrattenuteGenerali.Value = rs!TotaleTrattenuteGenerali
'    Me.txtTotaleTrattenutePerLavorazioni.Value = rs!TotaleTrattenutePerLavorazioni
...
'    Me.txtTotaleTrattenute.Value = Me.txtTotaleTrattenuteConferimento.Value + Me.txtTotaleTrattenuteGenerali.Value + Me.txtTotaleTrattenutePerLavorazioni.Value
    ...
    TotaleIva = FormatNumber(fnNotNullN(rs!TotaleImposta), 2)
    TotaleDocumento = FormatNumber(fnNotNullN(rs!TotaleImponibile), 2)
    TotaleTrattenutaPerLavorazione = FormatNumber(fnNotNullN(rs!TotaleTrattenutePerLavorazioni), 2)
    TotaleTrattenutaPerConferimento = FormatNumber(fnNotNullN(rs!TotaleTrattenutaConferimento), 2)
    TotaleTrattenutaGenerale = FormatNumber(fnNotNullN(rs!TotaleTrattenuteGenerali), 2)
    
    TotaleTrattenutaPerSocio = 0
    TotaleImportoLordo = TotaleIva + TotaleDocumento
    TotaleTrattenute = FormatNumber(fnNotNullN(rs!TrattenuteTotali), 2)
...
Me.txtTotaleDocumento.Value = TotaleDocumento
Me.txtTotaleIvaDocumento.Value = TotaleIva
Me.txtTotaleLordoDocumento.Value = TotaleImportoLordo
Me.txtTotaleTrattenuteConferimento.Value = TotaleTrattenutaPerConferimento
Me.txtTotaleTrattenuteGenerali.Value = TotaleTrattenutaGenerale
Me.txtTotaleTrattenutePerLavorazioni.Value = TotaleTrattenutaPerLavorazione
'Me.txtTotaleTrattenute.Value = fnNotNullN(rs!TrattenuteTotali)
Me.txtTotaleTrattenute.Value = TotaleTrattenute


If TIPO_IMPORTO_DOCUMENTO <= 1 Then
    Me.txtNettoLiquidazione.Value = TotaleDocumento - TotaleTrattenute - Me.txtTotaleTrattenuteAgg.Value - Me.txtTotaleTrattAggRiep.Value
Else
    Me.txtNettoLiquidazione.Value = TotaleImportoLordo - TotaleTrattenute - Me.txtTotaleTrattenuteAgg.Value - Me.txtTotaleTrattAggRiep.Value
End If
...
Set rs = Nothing
End Function
Private Sub RICALCOLO_NUOVE_TRATTENUTA(idliquidazione As Long, TotaleDocumento As Double, Optional tipo As Integer = 1, Optional TotaleTrattenute As Double = 0, Optional TotaleTrattenuteGen As Double = 0, Optional TotaleTrattenuteLav As Double = 0)
Dim sSQL As String
Dim rs As ADODB.Recordset
...
'CON CONFIGURAZIONE SU TRATTENUTE
If (tipo = 2) Then
    RICALCOLO_TRATT_AGG_SU_TRATT TotaleTrattenute, TotaleTrattenuteGen, TotaleTrattenuteLav
End If
...
End Sub
Private Function GET_LIQ_COLLEGATA(idliquidazione As Long) As Long
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
...
sSQL = sSQL & " WHERE IDRV_POLiquidazioneCollegata=" & idliquidazione

Set rs = Cn.OpenResultset(sSQL)

If Not rs.EOF Then
    GET_LIQ_COLLEGATA = fnNotNullN(rs!IDRV_POLiquidazione)
End If
...
Private Function GET_DESCR_LIQ_COLL(idliquidazione As Long) As String
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
...
If Not rs.EOF Then
    GET_DESCR_LIQ_COLL = "Liquidazione numero " & fnNotNullN(rs!NumeroLiquidazione) & " del " & fnNotNull(rs!DataLiquidazione)
End If
...
Private Function GET_IMPORTI_LIQ_COLL(idliquidazione As Long) As Double
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

GET_IMPORTI_LIQ_COLL = 0

sSQL = "SELECT IDRV_POLiquidazione, NettoLiquidazione "
...
If Not rs.EOF Then
    GET_IMPORTI_LIQ_COLL = fnNotNullN(rs!NettoLiquidazione)
End If
...
Private Sub GET_PARAMETRI_LIQ_FILIALE(IDFiliale As Long)
On Error GoTo ERR_GET_PARAMETRI_LIQUIDAZIONE
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
...
If rs.EOF Then
    SBLOCCA_LIQ_COLL = 0
Else
    SBLOCCA_LIQ_COLL = Abs(fnNotNullN(rs!SbloccaModificheLiquidazioniColl))
End If
...
Exit Sub
ERR_GET_PARAMETRI_LIQUIDAZIONE:
    MsgBox Err.Description, vbCritical, "GET_PARAMETRI_LIQ_FILIALE"
End Sub
