...
On Error GoTo ERR_fnGrigliaCommissioni
Dim sSQL As String
...
ERR_fnGrigliaCommissioni:
    MsgBox Err.Description, vbCritical, "Griglia commissioni"
...
On Error GoTo ERR_cboCommissioni_Click
Dim sSQL As String
...
End If
Exit Sub
ERR_cboCommissioni_Click:
    MsgBox Err.Description, vbCritical, "cboCommissioni_Click"
End Sub
...
On Error GoTo ERR_GrigliaCommissioni_Reposition
    NuovoRecordComm = 0
...
Exit Sub
ERR_GrigliaCommissioni_Reposition:
    MsgBox Err.Description, vbCritical, "GrigliaCommissioni_Reposition"
End Sub
