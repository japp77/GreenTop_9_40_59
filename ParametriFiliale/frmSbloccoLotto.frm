VERSION 5.00
Begin VB.Form frmSbloccoLotto 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Utenti sblocco lotto di campagna"
   ClientHeight    =   4875
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   4230
   Icon            =   "frmSbloccoLotto.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4875
   ...
   End
End
Attribute VB_Name = "frmSbloccoLotto"
...
sSQL = "DELETE RV_POUtentiSbloccoLottoCampagna "
...
For i = 0 To Me.lstUtenti.ListCount - 1
    If Me.lstUtenti.Selected(i) = True Then
        sSQL = "INSERT INTO RV_POUtentiSbloccoLottoCampagna ("
