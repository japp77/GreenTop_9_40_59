      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Top             =   120
               Width           =   14535
               Begin DMTDataCmb.DMTCombo cboTipoStatoAntSoci 
                  Height          =   315
                  Left            =   11280
                  TabIndex        =   75
                  Top             =   1080
               ...
               Begin VB.TextBox txtAnnotazioni 
                  ...
                  Width           =   14295
               End
               Begin DMTEDITNUMLib.dmtNumber txtTassoInteresseGiorno 
                  Height          =   315
                  Left            =   10680
                  TabIndex        =   5
                  TabStop         =   0   'False
                  ...
                  AllowEmpty      =   0   'False
               End
               Begin DMTEDITNUMLib.dmtNumber txtTassoInteresseAnnuo 
                  Height          =   315
                  Left            =   8760
                  TabIndex        =   4
                  TabStop         =   0   'False
               ...
               Begin DMTEDITNUMLib.dmtNumber txtNumeroDocumento 
                  ...
                  Appearance      =   1
               End
               Begin DMTEDITNUMLib.dmtNumber txtNumeroDocumentoSocio 
                  Height          =   315
                  Left            =   13320
                  TabIndex        =   3
                  TabStop         =   0   'False
                  ...
                  Appearance      =   1
               End
               Begin DMTDATETIMELib.dmtDate txtDataAnticipazione 
                  Height          =   315
                  Left            =   7080
                  TabIndex        =   1
                  Top             =   480
               ...
               Begin DmtCodDescCtl.DmtCodDesc CDSocio 
                  ...
                  BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  MenuFunctions   =   $"frmMain.frx":47A92
                  BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
                  ...
                  Enabled         =   0   'False
               End
               Begin DMTEDITNUMLib.dmtNumber txtImportoAnticipato 
                  Height          =   315
                  Left            =   120
                  TabIndex        =   6
                  Top             =   1080
                  ...
                  AllowEmpty      =   0   'False
               End
               Begin DMTEDITNUMLib.dmtNumber txtImportoRestituito 
                  Height          =   315
                  Left            =   2640
                  TabIndex        =   7
                  Top             =   1080
                  ...
                  AllowEmpty      =   0   'False
               End
               Begin DMTEDITNUMLib.dmtNumber txtImportoDaRestituire 
                  Height          =   315
                  Left            =   6960
                  TabIndex        =   9
                  Top             =   1080
                  ...
                  AllowEmpty      =   0   'False
               End
               Begin DMTEDITNUMLib.dmtNumber txtImportoDaElaborare 
                  Height          =   315
                  Left            =   4800
                  TabIndex        =   8
                  Top             =   1080
                  ...
                  AllowEmpty      =   0   'False
               End
               Begin DMTEDITNUMLib.dmtNumber txtTotaleInteressi 
                  Height          =   315
                  Left            =   9120
                  TabIndex        =   70
                  Top             =   1080
            ...
            Begin VB.Frame fraRighe 
               ...
               Begin TabDlg.SSTab SSTab1 
                  ...
                  BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  TabCaption(0)   =   "Restituzione anticipazioni"
                  TabPicture(0)   =   "frmMain.frx":47AEC
                  Tab(0).ControlEnabled=   -1  'True
                  Tab(0).Control(0)=   "Label3(9)"
                  Tab(0).Control(0).Enabled=   0   'False
                  Tab(0).Control(1)=   "Label3(10)"
                  Tab(0).Control(1).Enabled=   0   'False
                  Tab(0).Control(2)=   "Label3(11)"
                  Tab(0).Control(2).Enabled=   0   'False
                  Tab(0).Control(3)=   "Label3(12)"
                  Tab(0).Control(3).Enabled=   0   'False
                  Tab(0).Control(4)=   "Label9"
                  Tab(0).Control(4).Enabled=   0   'False
                  Tab(0).Control(5)=   "cboIva"
                  Tab(0).Control(5).Enabled=   0   'False
                  Tab(0).Control(6)=   "txtInteressiRiga"
                  Tab(0).Control(6).Enabled=   0   'False
                  Tab(0).Control(7)=   "txtNumeroGiorniRiga"
                  Tab(0).Control(7).Enabled=   0   'False
                  Tab(0).Control(8)=   "txtImportoRestituitoRiga"
                  Tab(0).Control(8).Enabled=   0   'False
                  Tab(0).Control(9)=   "txtDataRestituzione"
                  Tab(0).Control(9).Enabled=   0   'False
                  Tab(0).Control(10)=   "GrigliaCorpo"
                  ...
                  Begin VB.Frame Frame3 
                     Caption         =   "Informazione importo di capitale"
                     BeginProperty Font 
                        Name            =   "Verdana"
                        Size            =   8.25
                        Charset         =   0
                     ...
                     Top             =   1080
                     Width           =   14055
                     Begin VB.TextBox txtNumeroDocumentoCollegato 
                        Enabled         =   0   'False
                        Height          =   315
                        Left            =   7200
                        TabIndex        =   77
                        ...
                        Width           =   1695
                     End
                     Begin VB.CommandButton cmdEliminaRifDoc 
                        Height          =   315
                        Left            =   3360
                        Picture         =   "frmMain.frx":47B08
                        Style           =   1  'Graphical
                        TabIndex        =   17
                        TabStop         =   0   'False
                        ...
                        Width           =   495
                     End
                     Begin VB.TextBox TxtAnnotazioniCapitale 
                        Height          =   975
                        Left            =   9000
                        MultiLine       =   -1  'True
                        ScrollBars      =   2  'Vertical
                        ...
                        Width           =   4935
                     End
                     Begin VB.TextBox txtTrattenutaAggiuntivaCapitale 
                        Height          =   315
                        Left            =   120
                        MultiLine       =   -1  'True
                        ScrollBars      =   2  'Vertical
                        ...
                        Width           =   5775
                     End
                     Begin DMTDATETIMELib.dmtDate txtDataDocumentoCollegato 
                        Height          =   315
                        Left            =   5880
                        TabIndex        =   20
                        TabStop         =   0   'False
                        ...
                        Appearance      =   1
                     End
                     Begin DMTEDITNUMLib.dmtNumber txtNumeroDocumentoCollegato_ 
                        Height          =   315
                        Left            =   7800
                        TabIndex        =   21
                        TabStop         =   0   'False
                     ...
                     Begin DMTEDITNUMLib.dmtNumber txtIDOggetto 
                        ...
                        Appearance      =   1
                     End
                     Begin VB.CommandButton cmdTrovaDocumento 
                        Height          =   315
                        Left            =   3840
                        Picture         =   "frmMain.frx":48092
                        Style           =   1  'Graphical
                        TabIndex        =   18
                        TabStop         =   0   'False
                        ToolTipText     =   "Trova fatture per conto del socio"
                        Top             =   480
                        Width           =   495
                     End
                     Begin DMTDataCmb.DMTCombo cboTipoStatoCapitale 
                        Height          =   315
                        Left            =   120
                        TabIndex        =   16
                        Top             =   480
                        ...
                        EndProperty
                     End
                     Begin DMTDataCmb.DMTCombo cboTipoTrattAggCapitale 
                        Height          =   315
                        Left            =   6000
                        TabIndex        =   23
                        Top             =   1080
                     ...
                     Begin VB.Label Label8 
                        Caption         =   "Descrizione acconto su documento"
                        Height          =   255
                        Left            =   120
                        TabIndex        =   68
                        Top             =   840
                  ...
                  Begin VB.Frame Frame2 
                     Caption         =   "Informazioni importo di interesse"
                     BeginProperty Font 
                        Name            =   "Verdana"
                        Size            =   8.25
                        Charset         =   0
                     ...
                     Top             =   2640
                     Width           =   14055
                     Begin VB.TextBox txtAnnotazioniInteressi 
                        Height          =   975
                        Left            =   9000
                        MultiLine       =   -1  'True
                        ScrollBars      =   2  'Vertical
                        ...
                        Width           =   4935
                     End
                     Begin VB.TextBox txtTrattenutaAggiuntivaInteresse 
                        Height          =   315
                        Left            =   120
                        MultiLine       =   -1  'True
                        ScrollBars      =   2  'Vertical
                        ...
                        Width           =   5775
                     End
                     Begin DMTDataCmb.DMTCombo cboTipoStatoInteresse 
                        Height          =   315
                        Left            =   120
                        TabIndex        =   25
                        Top             =   480
                     ...
                     Begin DmtCodDescCtl.DmtCodDesc CDPeriodoLiquidazione 
                        ...
                        BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                           ...
                           Strikethrough   =   0   'False
                        EndProperty
                        PropDescrizione =   $"frmMain.frx":48674
                        BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                           Name            =   "Verdana"
                           Size            =   8.25
                           Charset         =   0
                           ...
                           Strikethrough   =   0   'False
                        EndProperty
                        MenuFunctions   =   $"frmMain.frx":486D7
                        BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                           Name            =   "Verdana"
                           Size            =   8.25
                           Charset         =   0
                        ...
                        TableName       =   "e"
                     End
                     Begin DMTDataCmb.DMTCombo cboTipoTrattAggInteresse 
                        Height          =   315
                        Left            =   6000
                        TabIndex        =   28
                        Top             =   1080
                     ...
                     Begin VB.Label Label5 
                        Caption         =   "Descrizione trattenuta aggiuntiva"
                        Height          =   255
                        Left            =   120
                        TabIndex        =   61
                        Top             =   840
                  ...
                  End
                  Begin DMTDATETIMELib.dmtDate txtDataRestituzione 
                     Height          =   315
                     Left            =   120
                     TabIndex        =   11
                     Top             =   720
                     ...
                     Appearance      =   1
                  End
                  Begin DMTEDITNUMLib.dmtNumber txtImportoRestituitoRiga 
                     Height          =   315
                     Left            =   1800
                     TabIndex        =   12
                     Top             =   720
                     ...
                     AllowEmpty      =   0   'False
                  End
                  Begin DMTEDITNUMLib.dmtNumber txtNumeroGiorniRiga 
                     Height          =   315
                     Left            =   3720
                     TabIndex        =   13
                     TabStop         =   0   'False
                     ...
                     AllowEmpty      =   0   'False
                  End
                  Begin DMTEDITNUMLib.dmtNumber txtInteressiRiga 
                     Height          =   315
                     Left            =   4920
                     TabIndex        =   14
                     Top             =   720
...
Private FLAG_CARICAMENTO_DATI_RIGA As Boolean
...
Private Function PermissionToSave() As Boolean
    ...
    If Me.CDSocio.KeyFieldID = 0 Then
        MsgBox "Inserire l'anagrafica del socio\Fornitore", vbInformation, "Controllo inserimento dati"
        Me.CDSocio.SetFocus
        PermissionToSave = False
        Exit Function
    End If

    If Me.txtDataAnticipazione.Value = 0 Then
        MsgBox "Inserire la data di anticipazione capitale", vbInformation, "Controllo inserimento dati"
        Me.txtDataAnticipazione.SetFocus
        PermissionToSave = False
        Exit Function
    End If

    If Me.txtNumeroDocumento.Value = 0 Then
        MsgBox "Inserire il numero documento", vbInformation, "Controllo inserimento dati"
        Me.txtNumeroDocumento.SetFocus
        PermissionToSave = False
        Exit Function
    End If

    If Me.txtNumeroDocumentoSocio.Value = 0 Then
        MsgBox "Inserire il numero documento progressivo del socio", vbInformation, "Controllo inserimento dati"
        Me.txtNumeroDocumentoSocio.SetFocus
        PermissionToSave = False
        Exit Function
    End If
...
'    m_Semaphore.SetObjectAction m_DocType.ID, SemAllObjects, SemInsertAction
    ...
    Me.txtNumeroDocumento.Value = GET_NUMERO_DOCUMENTO(Date, 0)
...
Private Sub ClearControl(ByVal ctrControl As Control)
    ...
    ElseIf sType = "CheckBox" Then
        ctrControl.Value = 0
    ElseIf sType = "dmtDate" Then
        ctrControl.Value = 0
    ElseIf sType = "dmtNumber" Then
        ctrControl.Value = 0
...
Private Sub CreateFormFields()
    ...
    Set Field = New FormField
    Set Field.Control = Me.txtDataAnticipazione
    Field.Name = "DataAnticipazione"
    Field.Visible = True
    Me.txtDataAnticipazione.Tag = Field.Name
    m_FormFields.Add Field
    
    Set Field = New FormField
    Set Field.Control = Me.txtNumeroDocumento
    Field.Name = "NumeroAnticipazioneProgressivo"
    Field.Visible = True
    Me.txtNumeroDocumento.Tag = Field.Name
    m_FormFields.Add Field
    
    Set Field = New FormField
    Set Field.Control = Me.txtNumeroDocumentoSocio
    Field.Name = "NumeroAnticipazioneSocio"
    Field.Visible = True
    Me.txtNumeroDocumentoSocio.Tag = Field.Name
    m_FormFields.Add Field

    Set Field = New FormField
    Set Field.Control = Me.txtImportoAnticipato
    Field.Name = "ImportoAnticipazione"
    Field.Visible = True
    Me.txtImportoAnticipato.Tag = Field.Name
    m_FormFields.Add Field

    Set Field = New FormField
    Set Field.Control = Me.txtTassoInteresseAnnuo
    Field.Name = "TassoInteresse"
    Field.Visible = True
    Me.txtTassoInteresseAnnuo.Tag = Field.Name
    m_FormFields.Add Field
    
    
    Set Field = New FormField
    Set Field.Control = Me.txtNumeroGiorniAnno
    Field.Name = "NumeroGiorniAnno"
    Field.Visible = True
    Me.txtNumeroGiorniAnno.Tag = Field.Name
    m_FormFields.Add Field
    
    Set Field = New FormField
    Set Field.Control = Me.txtTassoInteresseGiorno
    Field.Name = "TassoInteresseGiornaliero"
    Field.Visible = True
    Me.txtTassoInteresseGiorno.Tag = Field.Name
    m_FormFields.Add Field

    Set Field = New FormField
    Set Field.Control = Me.txtImportoRestituito
    Field.Name = "ImportoRestituito"
    Field.Visible = True
    Me.txtImportoRestituito.Tag = Field.Name
    m_FormFields.Add Field

    Set Field = New FormField
    Set Field.Control = Me.txtImportoDaRestituire
    Field.Name = "ImportoDaRestituire"
    Field.Visible = True
    Me.txtImportoDaRestituire.Tag = Field.Name
    m_FormFields.Add Field

    Set Field = New FormField
    Set Field.Control = Me.txtImportoDaElaborare
    Field.Name = "ImportoDaElaborare"
    Field.Visible = True
    Me.txtImportoDaElaborare.Tag = Field.Name
    m_FormFields.Add Field

    Set Field = New FormField
    Set Field.Control = Me.txtTotaleInteressi
    Field.Name = "TotaleInteressi"
    Field.Visible = True
    Me.txtTotaleInteressi.Tag = Field.Name
    m_FormFields.Add Field
    ...
    Set Field = New FormField
    Set Field.Control = Me.cboTipoStatoAntSoci
    Field.Name = "IDRV_POTipoStatoAntSoci"
    Field.Visible = True
    Me.cboTipoStatoAntSoci.Tag = Field.Name
    m_FormFields.Add Field
...
'**************************QUADRATURA DI VENDITA*******************************

    'Crea un sottodocumento basato sulla tabella di cross "RV_POCaricoMerceRighe"
    
    Set m_DocumentsLink1 = m_Document.AddDocumentsLink("RV_POAnticipazioniSocioRighe")
          
    'Impostazioni dell'oggetto DocumentsLink
    m_DocumentsLink1.EnableRefreshLinks = True '<-- Abilita il refresh dei campi collegati
    m_DocumentsLink1.PrimaryKey = "IDRV_POAnticipazioniSocioRighe" '<-- Specifica il campo chiave primaria
    
    'Crea un Link LEFT JOIN sulla tabella Funzione per prelevare il nome della funzione di movimento
    Set NewLink = m_DocumentsLink1.AddLink("IDRV_POLiquidazione", "RV_POLiquidazione", ltLeft, "IDRV_POLiquidazione")
    NewLink.AddLinkColumn "RV_POLiquidazione.NumeroLiquidazione"
    NewLink.AddLinkColumn "RV_POLiquidazione.DataLiquidazione"
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("Anagrafica", "Anagrafica", m_DocType.TableName, False, False, False, dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("Nome", "Nome", m_DocType.TableName, False, False, False, dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("IDRV_POTipoStatoAntSoci", "Stato ant. soci", m_DocType.TableName, False, False, , dgCondTypeComboDB)
        Cond.RecordSource = "SELECT * FROM RV_POTipoStatoAntSoci ORDER BY TipoStatoAntSoci"
        Cond.DisplayField = "TipoStatoAntSoci"
        Cond.KeyField = "IDRV_POTipoStatoAntSoci"
    Set Cond = BrwMain.Conditions.Add("DataAnticipazione", "Data anticipazione", m_DocType.TableName, False, True, False, dgCondTypeDate)
...
Private Function ChooseAboutSaving() As Integer
    If m_Changed Then
        gResource.CustomStrings.Clear
        gResource.CustomStrings.Add Chr(34) & "Anticipazione dei soci" & Chr(34), 1
...
'SETTARE LE GRIGLIE DEI SOTTODOCUMENTI
    ...
    If Me.GrigliaCorpo.ColumnsHeader.Count = 0 Then
        With Me.GrigliaCorpo.ColumnsHeader
            .Add "IDRV_POAnticipazioniSocioRighe", "IDRV_POAnticipazioniSocioRighe", dgInteger, False, 500, 0, True, True, False
            .Add "IDRV_POAnticipazioniSocio", "IDRV_POAnticipazioniSocio", dgInteger, False, 500, 0, True, True, False
            ...
            .Add "DataRestituzione", "Data restituzione", dgDate, True, 1200, 0, True, True, False
            
            'DATI DEL CAPITALE RESTITUITO
            Set cl = .Add("ImportoRestituito", "Importo", dgDouble, True, 1500, dgAlignRight, True, True, False)
                cl.FormatOptions.FormatNumericRegionalSettings = False
                cl.FormatOptions.UseFormatControlSettings = False
                cl.FormatOptions.FormatNumericDecSep = ","
                cl.FormatOptions.FormatNumericDecimals = 2
                cl.FormatOptions.FormatNumericThousandSep = "."
            .Add "IDRV_POTipoStatoAnticipazioneCapitale", "IDRV_POTipoStatoAnticipazioneCapitale", dgInteger, False, 500, 0, True, True, False
            .Add "TipoStatoAnticipazioneCapitale", "Stato Capitale", dgchar, True, 1500, 0, True, True, False
            .Add "DescrizioneTrattenutaAggiuntivaCapitale", "Descrizione acconto", dgchar, False, 3000, 0, True, True, False
            .Add "IDRV_POTipoTrattenutaAggiuntivaCapitale", "IDRV_POTipoTrattenutaAggiuntivaCapitale", dgInteger, False, 500, 0, True, True, False
            .Add "TipoTrattenutaAggiuntivaCapitale", "Tipo trattenuta", dgchar, True, 1500, 0, True, True, False
            .Add "IDOggetto", "IDOggetto", dgInteger, False, 500, 0, True, True, False
            .Add "DataDocumentoFattura", "Data documento", dgDate, False, 1200, 0, True, True, False
            .Add "NumeroDocumentoFattura", "N° Documento", dgchar, False, 1500, 0, True, True, False
            
            'DATI DEGLI INTERESSI MATURATI
            Set cl = .Add("NumeroGiorniPassati", "N° giorni passati", dgDouble, True, 1500, dgAlignRight, True, True, False)
                cl.FormatOptions.FormatNumericRegionalSettings = False
                cl.FormatOptions.UseFormatControlSettings = False
                cl.FormatOptions.FormatNumericDecSep = ","
                cl.FormatOptions.FormatNumericDecimals = 0
                cl.FormatOptions.FormatNumericThousandSep = "."
            Set cl = .Add("ImportoInteresse", "Interessi", dgDouble, True, 1500, dgAlignRight, True, True, False)
                cl.FormatOptions.FormatNumericRegionalSettings = False
                cl.FormatOptions.UseFormatControlSettings = False
                cl.FormatOptions.FormatNumericDecSep = ","
                cl.FormatOptions.FormatNumericDecimals = 5
                cl.FormatOptions.FormatNumericThousandSep = "."
            .Add "IDRV_POTipoStatoAnticipazioneInteresse", "IDRV_POTipoStatoAnticipazioneInteresse", dgInteger, False, 500, 0, True, True, False
            .Add "TipoStatoAnticipazioneInteresse", "Stato Interessi", dgchar, True, 1500, 0, True, True, False
            .Add "DescrizioneTrattenutaAggiuntivaInteresse", "Descrizione trattenuta", dgchar, False, 3000, 0, True, True, False
            .Add "IDRV_POTipoTrattenutaAggiuntivaInteresse", "IDRV_POTipoTrattenutaAggiuntivaInteresse", dgInteger, False, 500, 0, True, True, False
            .Add "TipoTrattenutaAggiuntivaInteresse", "Tipo trattenuta", dgchar, True, 1500, 0, True, True, False
            .Add "IDRV_POLiquidazione", "IDRV_POLiquidazione", dgInteger, False, 500, 0, True, True, False
            .Add "DataLiquidazione", "Data liquidazione", dgDate, False, 1200, 0, True, True, False
            .Add "NumeroLiquidazione", "N° Liquidazione", dgchar, False, 1500, 0, True, True, False
...
'''''''''''''''''''''''''CONTROLLI STANDARD''''''''''''''''''''''''''''''''''''
    ...
    With Me.CDSocio
        ...
        .DescriptionCaption4Find = "AnagraficaCompleta"
    ...
    With Me.CDPeriodoLiquidazione
        ...
        .KeyField = "IDRV_POLiquidazione"
        .TableName = "RV_PORepLiquidazione"
        .Filter = "IDAzienda = " & m_App.IDFirm & " AND IDAnagrafica=" & Me.CDSocio.KeyFieldID
        '.MenuFunctions("EseguiGestione").Enabled = True
    ...
    With Me.cboTipoStatoAntSoci
        Set .Database = m_App.Database.Connection
        .AddFieldKey "IDRV_POTipoStatoAntSoci"
        .DisplayField = "TipoStatoAntSoci"
        .SQL = "SELECT * FROM RV_POTipoStatoAntSoci ORDER BY TipoStatoAntSoci"
        .Fill
    End With


    With Me.cboTipoStatoInteresse
        Set .Database = m_App.Database.Connection
        .AddFieldKey "IDRV_POTipoStatoAnticipazione"
        .DisplayField = "TipoStatoAnticipazione"
        .SQL = "SELECT * FROM RV_POTipoStatoAnticipazione"
        .Fill
    End With
    
    With Me.cboTipoStatoCapitale
        Set .Database = m_App.Database.Connection
        .AddFieldKey "IDRV_POTipoStatoAnticipazione"
        .DisplayField = "TipoStatoAnticipazione"
        .SQL = "SELECT * FROM RV_POTipoStatoAnticipazione"
    ...
    With Me.cboTipoTrattAggInteresse
        Set .Database = m_App.Database.Connection
    ...
    With Me.cboTipoTrattAggCapitale
        Set .Database = m_App.Database.Connection
        .AddFieldKey "IDRV_POTipoTrattenutaAggiuntiva"
        .DisplayField = "TipoTrattenuta"
        .SQL = "SELECT * FROM RV_POTipoTrattenutaAggiuntiva"
...
Private Sub OnSave()
    ...
    If m_Document(m_Document.PrimaryKey).Value <= 0 Then
        If GET_CONTROLLO_ESISTENZA_NUMERO_DOCUMENTO(Date, 0, Me.txtNumeroDocumento.Value) = True Then
            Me.txtNumeroDocumento.Value = GET_NUMERO_DOCUMENTO(Date, 0)
        End If
        
        If GET_CONTROLLO_ESISTENZA_NUMERO_DOCUMENTO(Date, Me.CDSocio.KeyFieldID, Me.txtNumeroDocumentoSocio.Value) = True Then
            Me.txtNumeroDocumentoSocio.Value = GET_NUMERO_DOCUMENTO(Date, Me.CDSocio.KeyFieldID)
        End If
    End If
...
Private Sub OnDelete()
    ...
    'MsgBox "Impossibile eliminare l'anagrafica", vbInformation, "Eliminazione"
    'Exit Sub
...
Private Function fncListinoDefault() As Long
    ...
    Set rs = Nothing
End Function
Private Sub ACSSocioTesta_ChangedElement()
    If Me.ACSSocioTesta.IDAnagrafica > 0 Then
        If Me.ACSSocioTesta.IDAnagrafica <> Me.CDSocio.KeyFieldID Then
            Me.CDSocio.Load Me.ACSSocioTesta.IDAnagrafica
        End If
    End If
End Sub

Private Sub cboTipoStatoAntSoci_Click()
If Not (BrwMain.Visible) Then Change
End Sub

Private Sub cboTipoStatoCapitale_Click()
If BrwMain.GuiMode = dgFilterDefinition Then Exit Sub
If BrwMain.Visible = True Then Exit Sub
If FLAG_CARICAMENTO_DATI_RIGA = True Then Exit Sub
If Me.cboTipoStatoCapitale.CurrentID = 1 Then
    If Me.txtIDOggetto.Value > 0 Then
...
Private Sub cboTipoStatoInteresse_Click()
If BrwMain.GuiMode = dgFilterDefinition Then Exit Sub
If BrwMain.Visible = True Then Exit Sub
If FLAG_CARICAMENTO_DATI_RIGA = True Then Exit Sub

If Me.cboTipoStatoInteresse.CurrentID = 1 Then
    If Me.CDPeriodoLiquidazione.KeyFieldID > 0 Then
        Me.CDPeriodoLiquidazione.Load 0
    End If
End If
End Sub
...
If FLAG_CARICAMENTO_DATI_RIGA = True Then Exit Sub
    ...
    If Me.CDPeriodoLiquidazione.KeyFieldID > 0 Then
        If Me.cboTipoStatoInteresse.CurrentID = 1 Then
            ...
            Testo = Testo & "Lo stato di questa sezione non è compatibile avendo collegato una liquidazione" & vbCrLf
            Testo = Testo & "Vuoi cambiarlo?"
            If MsgBox(Testo, vbQuestion + vbYesNo, "Controllo inserimento dati") = vbYes Then
                Me.cboTipoStatoInteresse.WriteOn 2
            End If
        End If
    Else
    
        If Me.cboTipoStatoInteresse.CurrentID = 2 Then
            Testo = "ATTENZIONE!!!" & vbCrLf
            Testo = Testo & "Lo stato di questa sezione non è compatibile avendo eliminato una liquidazione" & vbCrLf
            Testo = Testo & "Vuoi cambiarlo?"
            If MsgBox(Testo, vbQuestion + vbYesNo, "Controllo inserimento dati") = vbYes Then
                Me.cboTipoStatoInteresse.WriteOn 1
            End If
        End If
...
On Error GoTo ERR_CDSocio_ChangeElement
    ...
    Me.ACSSocioTesta.sbLoadCFByIDAnagrafica 1, Me.CDSocio.KeyFieldID
...
Dim Testo As String
    ...
    If m_DocumentsLink1("IDRV_POLiquidazione").Value > 0 Then
        Testo = "ATTENZIONE!!!!" & vbCrLf
        Testo = Testo & "Eliminando questa riga si eliminano anche i collegamenti alla liquidazione." & vbCrLf
    ...
    Me.txtImportoDaElaborare.Value = GET_CAPITALE_DA_ELABORARE
    Me.txtImportoRestituito.Value = GET_CAPITALE_RESTITUITO
    Me.txtImportoDaRestituire.Value = Me.txtImportoAnticipato.Value - (Me.txtImportoDaElaborare.Value + Me.txtImportoRestituito.Value)
    Me.txtTotaleInteressi.Value = GET_TOTALI_INTERESSI

    If Not (m_DocumentsLink1.BOF And m_DocumentsLink1.EOF) Then
        m_DocumentsLink1.Move Me.GrigliaCorpo.ListIndex - 1
    Else
        Me.cmdNuovo.SetFocus
    End If
    
    
    
End Sub
Private Function AGGIORNA_ANTICIPAZIONI_LIQUIDAZIONE(IDLiquidazione As Long, IDAnticipazioneRighe As Long)
Dim sSQL As String

sSQL = "UPDATE RV_POLiquidazioneRighe SET "
sSQL = sSQL & "IDRV_POAnticipazioniSocioRighe=0, "
sSQL = sSQL & " IDRV_POAnticipazioniSocio=0 "
sSQL = sSQL & " WHERE IDRV_POLiquidazione=" & IDLiquidazione
sSQL = sSQL & " AND IDRV_POAnticipazioniSocioRighe=" & IDAnticipazioneRighe
...
Private Sub cmdEliminaRifDoc_Click()
Dim Testo As String
If Me.txtIDOggetto.Value > 0 Then
    Testo = "ATTENZIONE!!!!" & vbCrLf
    Testo = "Vuoi eliminare il riferimento al documento?"
...
If m_Document(m_Document.PrimaryKey).Value <= 0 Then Exit Sub
    ...
    Me.cboTipoStatoCapitale.WriteOn 1
    Me.cboTipoTrattAggCapitale.WriteOn 3
    
    Me.cboTipoStatoInteresse.WriteOn 1
    Me.cboTipoTrattAggInteresse.WriteOn 1
    
    Me.txtDataRestituzione.SetFocus
...
'On Error GoTo ERR_cmdSalva_Click
    ...
    If m_Document(m_Document.PrimaryKey).Value <= 0 Then
        MsgBox "Salvare il documento prima di inserire la restituzione del capitale", vbInformation, "Controllo inserimento dati"
        Exit Sub
    End If

    If Me.txtDataRestituzione.Value = 0 Then
        MsgBox "Inserire la data di restituzione del capitale", vbInformation, "Controllo inserimento"
        Exit Sub
    End If
    If Me.txtImportoRestituitoRiga.Value = 0 Then
        MsgBox "Inserire l'importo di restituzione del capitale", vbInformation, "Controllo inserimento"
        Exit Sub
    End If
    If Me.txtDataAnticipazione.Value > Me.txtDataRestituzione.Value Then
        MsgBox "Incopatibilità tra la data di anticipazione e la data di restituzione", vbInformation, "Controllo inserimento dati"
        Exit Sub
    End If
    
    If m_DocumentsLink1(m_DocumentsLink1.PrimaryKey).Value <= 0 Then
        If Me.txtImportoDaRestituire.Value < Me.txtImportoRestituitoRiga.Value Then
            MsgBox "L'importo restituito non può essere maggiore dell'importo da restituire", vbInformation, "Controllo inserimento dati"
            Exit Sub
        End If
    Else
        If Me.txtImportoAnticipato.Value < (Me.txtImportoAnticipato.Value - (Me.txtImportoDaRestituire.Value + fnNotNullN(m_DocumentsLink1("ImportoRestituito").Value)) + Me.txtImportoRestituitoRiga.Value) Then
            MsgBox "L'importo restituito non può essere maggiore dell'importo da restituire", vbInformation, "Controllo inserimento dati"
            Exit Sub
        End If
    End If
    ...
    'DATI GENERALI
    m_DocumentsLink1("IDAnagrafica").Value = Me.CDSocio.KeyFieldID
    m_DocumentsLink1("IDFiliale").Value = TheApp.Branch
    m_DocumentsLink1("IDAzienda").Value = TheApp.IDFirm
    m_DocumentsLink1("DataRestituzione").Value = Me.txtDataRestituzione.Value
    m_DocumentsLink1("ImportoRestituito").Value = Me.txtImportoRestituitoRiga.Value
    m_DocumentsLink1("NumeroGiorniPassati").Value = Me.txtNumeroGiorniRiga.Value
    m_DocumentsLink1("IDIva").Value = Me.cboIva.CurrentID
    'DATI INTERESSE
    m_DocumentsLink1("ImportoInteresse").Value = Me.txtInteressiRiga.Value
    m_DocumentsLink1("IDRV_POTipoStatoAnticipazioneInteresse").Value = Me.cboTipoStatoInteresse.CurrentID
    m_DocumentsLink1("TipoStatoAnticipazioneInteresse").Value = Me.cboTipoStatoInteresse.Text
    m_DocumentsLink1("DescrizioneTrattenutaAggiuntivaInteresse").Value = Me.txtTrattenutaAggiuntivaInteresse.Text
    m_DocumentsLink1("IDRV_POTipoTrattenutaAggiuntivaInteresse").Value = Me.cboTipoTrattAggInteresse.CurrentID
    m_DocumentsLink1("TipoTrattenutaAggiuntivaInteresse").Value = Me.cboTipoTrattAggInteresse.Text
    m_DocumentsLink1("AnnotazioniInteresse").Value = Me.txtAnnotazioniInteressi.Text
    m_DocumentsLink1("IDRV_POLiquidazione").Value = Me.CDPeriodoLiquidazione.KeyFieldID
    
    'DATI DEL CAPITALE
    m_DocumentsLink1("IDOggetto").Value = Me.txtIDOggetto.Value
    m_DocumentsLink1("NumeroDocumentoFattura").Value = Me.txtNumeroDocumentoCollegato.Text
    If Me.txtDataDocumentoCollegato.Value > 0 Then
        m_DocumentsLink1("DataDocumentoFattura").Value = Me.txtDataDocumentoCollegato.Value
    End If
    m_DocumentsLink1("IDRV_POTipoStatoAnticipazioneCapitale").Value = Me.cboTipoStatoCapitale.CurrentID
    m_DocumentsLink1("TipoStatoAnticipazioneCapitale").Value = Me.cboTipoStatoCapitale.Text
    m_DocumentsLink1("DescrizioneTrattenutaAggiuntivaCapitale").Value = Me.txtTrattenutaAggiuntivaCapitale.Text
    m_DocumentsLink1("IDRV_POTipoTrattenutaAggiuntivaCapitale").Value = Me.cboTipoTrattAggCapitale.CurrentID
    m_DocumentsLink1("TipoTrattenutaAggiuntivaCapitale").Value = Me.cboTipoTrattAggCapitale.Text
    m_DocumentsLink1("AnnotazioniCapitale").Value = Me.TxtAnnotazioniCapitale.Text
...
Private Sub cmdTrovaDocumento_Click()
    If m_Document(m_Document.PrimaryKey).Value <= 0 Then Exit Sub
    
    frmFatturaAcquisto.Show vbModal
End Sub
...
'            End If
   ...
   'If Me.GrigliaFasiIntervento.ColumnsHeader.Count > 0 Then
       On Error Resume Next
        ...
        'Set Me.GrigliaQuadratura.Recordset = m_Document.DocumentsLinks.Item(m_DocumentsLink1.TableName).Data
    'End If
...
On Error Resume Next
FLAG_CARICAMENTO_DATI_RIGA = True
    If Not (m_DocumentsLink1.BOF And m_DocumentsLink1.EOF) Then
        'Il DocumentsLink non è vuoto - contiene dei dati.
        

        Me.txtDataRestituzione.Value = fnNotNullN(m_DocumentsLink1("DataRestituzione").Value)
        Me.txtImportoRestituitoRiga.Value = fnNotNullN(m_DocumentsLink1("ImportoRestituito").Value)
        Me.txtNumeroGiorniRiga.Value = fnNotNullN(m_DocumentsLink1("NumeroGiorniPassati").Value)
        'DATI INTERESSE
        Me.txtInteressiRiga.Value = fnNotNullN(m_DocumentsLink1("ImportoInteresse").Value)
        Me.cboTipoStatoInteresse.WriteOn fnNotNullN(m_DocumentsLink1("IDRV_POTipoStatoAnticipazioneInteresse").Value)
        Me.txtTrattenutaAggiuntivaInteresse.Text = fnNotNull(m_DocumentsLink1("DescrizioneTrattenutaAggiuntivaInteresse").Value)
        Me.cboTipoTrattAggInteresse.WriteOn fnNotNullN(m_DocumentsLink1("IDRV_POTipoTrattenutaAggiuntivaInteresse").Value)
        Me.txtAnnotazioniInteressi.Text = fnNotNull(m_DocumentsLink1("AnnotazioniInteresse").Value)
        Me.CDPeriodoLiquidazione.Load fnNotNullN(m_DocumentsLink1("IDRV_POLiquidazione").Value)

        'DATI DEL CAPITALE
        Me.txtIDOggetto.Value = fnNotNullN(m_DocumentsLink1("IDOggetto").Value)
        Me.cboTipoStatoCapitale.WriteOn fnNotNullN(m_DocumentsLink1("IDRV_POTipoStatoAnticipazioneCapitale").Value)
        Me.txtTrattenutaAggiuntivaCapitale.Text = fnNotNull(m_DocumentsLink1("DescrizioneTrattenutaAggiuntivaCapitale").Value)
        Me.cboTipoTrattAggCapitale.WriteOn fnNotNullN(m_DocumentsLink1("IDRV_POTipoTrattenutaAggiuntivaCapitale").Value)
        Me.TxtAnnotazioniCapitale.Text = fnNotNull(m_DocumentsLink1("AnnotazioniCapitale").Value)
        Me.cboIva.WriteOn fnNotNullN(m_DocumentsLink1("IDIva").Value)
    ...
    Else
        ...
        '---------------------------------------------
        Me.txtDataRestituzione.Value = 0
        Me.txtImportoRestituitoRiga.Value = 0
        Me.txtNumeroGiorniRiga.Value = 0
        'DATI INTERESSE
        Me.txtInteressiRiga.Value = 0
        Me.cboTipoStatoInteresse.WriteOn 0
        Me.txtTrattenutaAggiuntivaInteresse.Text = ""
        Me.cboTipoTrattAggInteresse.WriteOn 0
        Me.txtAnnotazioniInteressi.Text = ""
        Me.CDPeriodoLiquidazione.Load 0
        Me.cboIva.WriteOn 0
        'DATI DEL CAPITALE
        Me.txtIDOggetto.Value = 0
        Me.cboTipoStatoCapitale.WriteOn 0
        Me.txtTrattenutaAggiuntivaCapitale.Text = ""
        Me.cboTipoTrattAggCapitale.WriteOn 0
        Me.TxtAnnotazioniCapitale.Text = ""
    ...
    Me.txtDataRestituzione.Enabled = bValue
    
    Me.txtImportoRestituitoRiga.Enabled = bValue
    
    Me.cboTipoStatoInteresse.Enabled = bValue
    Me.txtTrattenutaAggiuntivaInteresse.Enabled = bValue
    Me.cboTipoTrattAggInteresse.Enabled = bValue
    Me.txtAnnotazioniInteressi.Enabled = bValue
    Me.CDPeriodoLiquidazione.Enabled = bValue
    
    'DATI DEL CAPITALE
    'Me.txtIDOggetto.Enabled = bValue
    Me.cboTipoStatoCapitale.Enabled = bValue
    Me.txtTrattenutaAggiuntivaCapitale.Enabled = bValue
    Me.cboTipoTrattAggCapitale.Enabled = bValue
    Me.TxtAnnotazioniCapitale.Enabled = bValue
...
FLAG_CARICAMENTO_DATI_RIGA = False
End Sub
...
Private Sub Start()
    ...
    Set m_Document.ActiveFilter = m_ActiveFilter
        m_Document.Dataset.Recordset.Sort = "DataAnticipazione DESC, NumeroAnticipazioneProgressivo DESC"
...
Private Sub txtDataAnticipazione_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtDataAnticipazione_LostFocus()
On Error Resume Next
If fnNotNullN(m_Document(m_Document.PrimaryKey).Value) <= 0 Then
    GET_INTERESSE_CONFIGURAZIONE_ANNUO Me.txtDataAnticipazione.Text
End If
End Sub



Private Sub txtDataRestituzione_LostFocus()
    If Me.txtDataAnticipazione.Value < Me.txtDataRestituzione.Value Then
        If Me.txtImportoRestituitoRiga.Value > 0 Then
            Me.txtNumeroGiorniRiga.Value = DateDiff("d", Me.txtDataAnticipazione.Text, Me.txtDataRestituzione.Text)
            Me.txtInteressiRiga.Value = ((Me.txtImportoRestituitoRiga.Value / 100) * (Me.txtNumeroGiorniRiga.Value * Me.txtTassoInteresseGiorno.Value))
        End If
    End If
End Sub
...
sSQL = "SELECT Doc_Numero_presso_nom, Doc_data_presso_nom "
sSQL = sSQL & "FROM ValoriOggettoPerTipo012D "
sSQL = sSQL & " WHERE IDOggetto=" & Me.txtIDOggetto.Value

Set rs = Cn.OpenResultset(sSQL)

If rs.EOF Then
    Me.txtNumeroDocumentoCollegato.Text = ""
    Me.txtDataDocumentoCollegato.Value = 0
Else
    Me.txtNumeroDocumentoCollegato.Text = fnNotNull(rs!Doc_numero_Presso_nom)
    Me.txtDataDocumentoCollegato.Value = fnNotNullN(rs!Doc_data_Presso_nom)
End If
...
If Me.txtIDOggetto.Value > 0 Then
    If Me.cboTipoStatoCapitale.CurrentID = 1 Then
        Testo = "ATTENZIONE!!!" & vbCrLf
        Testo = Testo & "Lo stato di questa sezione non è compatibile avendo collegato una fattura per conto dei soci" & vbCrLf
        Testo = Testo & "Vuoi cambiarlo?"
        If MsgBox(Testo, vbQuestion + vbYesNo, "Controllo inserimento dati") = vbYes Then
            Me.cboTipoStatoCapitale.WriteOn 2
        End If
    End If
Else
    If Me.cboTipoStatoCapitale.CurrentID = 2 Then
        Testo = "ATTENZIONE!!!" & vbCrLf
        Testo = Testo & "Lo stato di questa sezione non è compatibile avendo eliminato una fattura per conto dei soci" & vbCrLf
        Testo = Testo & "Vuoi cambiarlo?"
        If MsgBox(Testo, vbQuestion + vbYesNo, "Controllo inserimento dati") = vbYes Then
            Me.cboTipoStatoCapitale.WriteOn 1
        End If
...
Private Sub txtImportoAnticipato_Change()
If m_Document(m_Document.PrimaryKey).Value <= 0 Then
    Me.txtImportoDaRestituire.Value = Me.txtImportoAnticipato.Value
...
Private Sub txtImportoDaElaborare_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtImportoDaRestituire_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtImportoRestituito_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtImportoRestituitoRiga_LostFocus()
    If Me.txtDataAnticipazione.Value < Me.txtDataRestituzione.Value Then
        If Me.txtImportoRestituitoRiga.Value > 0 Then
            Me.txtNumeroGiorniRiga.Value = DateDiff("d", Me.txtDataAnticipazione.Text, Me.txtDataRestituzione.Text)
            Me.txtInteressiRiga.Value = ((Me.txtImportoRestituitoRiga.Value / 100) * (Me.txtNumeroGiorniRiga.Value * Me.txtTassoInteresseGiorno.Value))
...
Private Sub txtNumeroDocumentoSocio_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtNumeroGiorniAnno_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtNumeroGiorniAnno_LostFocus()
If Me.txtNumeroGiorniAnno.Value > 0 Then
    Me.txtTassoInteresseGiorno.Value = Me.txtTassoInteresseAnnuo.Value / Me.txtNumeroGiorniAnno.Value
End If
End Sub

Private Sub txtTassoInteresseAnnuo_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtTassoInteresseAnnuo_LostFocus()
    If Me.txtNumeroGiorniAnno.Value > 0 Then
        Me.txtTassoInteresseGiorno.Value = Me.txtTassoInteresseAnnuo.Value / Me.txtNumeroGiorniAnno.Value
    End If
End Sub

Private Sub txtTassoInteresseGiorno_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtTotaleInteressi_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
Private Sub GET_INTERESSE_CONFIGURAZIONE_ANNUO(DataAnticipazione As String)
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

sSQL = "SELECT * FROM RV_POTassoInteresseAnnuo "
sSQL = sSQL & "WHERE IDAzienda=" & TheApp.IDFirm
sSQL = sSQL & " AND IDFiliale=" & TheApp.Branch
sSQL = sSQL & " AND DataInizio<=" & fnNormDate(DataAnticipazione)
sSQL = sSQL & " ORDER BY DataInizio DESC"

Set rs = Cn.OpenResultset(sSQL)


If rs.EOF Then
    Me.txtTassoInteresseAnnuo.Value = 0
    Me.txtNumeroGiorniAnno.Value = 0
    Me.txtTassoInteresseGiorno.Value = 0
Else
    Me.txtTassoInteresseAnnuo.Value = fnNotNullN(rs!TassoInteresse)
    Me.txtNumeroGiorniAnno.Value = fnNotNullN(rs!NumeroGiorniAnno)
    Me.txtTassoInteresseGiorno.Value = fnNotNullN(rs!TassoGiornaliero)
End If
...
Private Function GET_NUMERO_DOCUMENTO(DataAnticipazione As String, IDAnagraficaSocio As Long) As Long
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
...
IDEsercizio = fnGetEsercizio(DataAnticipazione)

DataInizio = GET_DATA_ESERCIZIO(IDEsercizio, "DataInizio")
DataFine = GET_DATA_ESERCIZIO(IDEsercizio, "DataFine")

sSQL = "SELECT MAX(NumeroAnticipazioneSocio) AS NumeroDocumentoSocio, "
sSQL = sSQL & " MAX (NumeroAnticipazioneProgressivo) AS NumeroDocumento "
sSQL = sSQL & "FROM RV_POAnticipazioniSocio "
sSQL = sSQL & "WHERE IDAzienda = " & TheApp.IDFirm
sSQL = sSQL & " AND DataAnticipazione>=" & fnNormDate(DataInizio)
sSQL = sSQL & " AND DataAnticipazione<=" & fnNormDate(DataFine)

If IDAnagraficaSocio > 0 Then
...
Else
    If IDAnagraficaSocio > 0 Then
        GET_NUMERO_DOCUMENTO = fnNotNullN(rs!NumeroDocumentoSocio) + 1
    Else
...
Set rs = Nothing
End Function
Private Function GET_DATA_ESERCIZIO(IDEsercizio As Long, NomeCampo As String) As String
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
...
If rs.EOF Then
    GET_DATA_ESERCIZIO = ""
Else
    GET_DATA_ESERCIZIO = fnNotNull(rs.adoColumns(NomeCampo).Value)
End If
...
Set rs = Nothing
End Function
Private Function GET_CONTROLLO_ESISTENZA_NUMERO_DOCUMENTO(DataInserimento As String, IDAnagraficaSocio As Long, NumeroDocumento As Long) As Boolean
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
Dim IDEsercizio As Long
Dim DataInizio As String
...
IDEsercizio = fnGetEsercizio(DataInserimento)

DataInizio = GET_DATA_ESERCIZIO(IDEsercizio, "DataInizio")
DataFine = GET_DATA_ESERCIZIO(IDEsercizio, "DataFine")
If IDAnagraficaSocio > 0 Then
    sSQL = "SELECT  NumeroAnticipazioneSocio "
Else
    sSQL = "SELECT NumeroAnticipazioneProgressivo "
End If
...
If IDAnagraficaSocio > 0 Then
    sSQL = sSQL & " AND IDAnagrafica=" & IDAnagraficaSocio
    sSQL = sSQL & " AND NumeroAnticipazioneSocio=" & NumeroDocumento

Else
    sSQL = sSQL & " AND NumeroAnticipazioneProgressivo=" & NumeroDocumento
End If

Set rs = Cn.OpenResultset(sSQL)

If rs.EOF Then
    GET_CONTROLLO_ESISTENZA_NUMERO_DOCUMENTO = False
Else
    GET_CONTROLLO_ESISTENZA_NUMERO_DOCUMENTO = True
End If

rs.CloseResultset
Set rs = Nothing
End Function
Private Function GET_CAPITALE_RESTITUITO() As Double
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

sSQL = "SELECT SUM(ImportoRestituito) AS Importo FROM RV_POAnticipazioniSocioRighe "
sSQL = sSQL & "WHERE IDRV_POAnticipazioniSocio=" & fnNotNullN(m_Document(m_Document.PrimaryKey).Value)
...
Set rs = Nothing
End Function
Private Function GET_CAPITALE_DA_ELABORARE() As Double
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
...
Set rs = Nothing
End Function
Private Function GET_TOTALI_INTERESSI() As Double
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

sSQL = "SELECT SUM(ImportoInteresse) AS Importo FROM RV_POAnticipazioniSocioRighe "
sSQL = sSQL & "WHERE IDRV_POAnticipazioniSocio=" & fnNotNullN(m_Document(m_Document.PrimaryKey).Value)

Set rs = Cn.OpenResultset(sSQL)

If rs.EOF Then
    GET_TOTALI_INTERESSI = 0
Else
    GET_TOTALI_INTERESSI = fnNotNullN(rs!Importo)
End If
