...
Begin VB.Form frmCommissioni 
   ...
   Begin VB.Frame Frame7 
      ...
      Begin DmtCodDescCtl.DmtCodDesc CDImballo 
         ...
         _ExtentX        =   7990
         _ExtentY        =   1085
         PropCodice      =   $"frmCommissioni.frx":47919
         BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         PropDescrizione =   $"frmCommissioni.frx":47968
         BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         MenuFunctions   =   $"frmCommissioni.frx":479C7
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
    ...
    Cn.CursorLocation = 3
        ...
        With Me.GrigliaCommissioni.ColumnsHeader
            .Clear
                ...
                Set cl = .Add("PercentualeDaCommissione", "% originale", dgDouble, True, 1500, dgAlignRight)
...
'                    cl.FormatOptions.FormatNumericThousandSep = "."
                ...
                .Add "CodiceArticoloImballo", "Codice imballo", dgchar, True, 2000, 0, True, True, False
                .Add "DescrizioneArticoloImballo", "Descrizione imballo", dgchar, False, 3000, 0, True, True, False
...
Private Sub ABILITA_CONTROLLI_COMMISSIONE(TIpo As Long)
    ...
    Select Case TIpo
        Case 1 'Commissione normale
            ...
            Me.CDImballo.Enabled = False
            If NuovoRecordComm = 1 Then
                Me.CDImballo.Enabled = True
...
If NuovoRecordComm = 1 Then
    ...
    sSQL = sSQL & "Quantita, APercentuale, ImportoTotale, IDRV_POTipoPedana, PercentualeDaCommissione, IDArticoloImballo "
    sSQL = sSQL & ") "
    sSQL = sSQL & "VALUES ("
    ...
    sSQL = sSQL & Me.CDImballo.KeyFieldID
    sSQL = sSQL & ")"
...
Else
    ...
    sSQL = sSQL & "IDArticoloImballo=" & Me.CDImballo.KeyFieldID
    sSQL = sSQL & " WHERE IDRV_POCommissioniPerDoc=" & fnNotNullN(Me.GrigliaCommissioni("IDRV_POCommissioniPerDoc").Value)
End If
...
Private Sub txtImportoCommissioni_LostFocus()
    GET_TOTALE_COMMISIONE
End Sub

Private Sub txtImportoRigaComm_LostFocus()
    GET_TOTALE_COMMISIONE
...
Private Sub InitControlli()
    ...
    With Me.CDImballo
        ...
        .KeyField = "IDArticolo"
        .TableName = "Articolo"
        .Filter = "IDAzienda = " & TheApp.IDFirm & " AND IDTipoProdotto=" & Link_TipoImballo
        .MenuFunctions("EseguiGestione").Enabled = False
        .PropCodice.Caption = "Codice"
        .PropDescrizione.Caption = "Descrizione"
        .CodeCaption4Find = "Codice"
...
Private Sub GrigliaCommissioni_Reposition(ByVal AllColumns As DmtGridCtl.dgColumns)
    ...
    NuovoRecordComm = 0
    Me.CDImballo.Load fnNotNullN(Me.GrigliaCommissioni("IDArticoloImballo").Value)
...
Private Sub txtQuantitaCommissione_LostFocus()
GET_TOTALE_COMMISIONE
End Sub
