VERSION 5.00
Object = "{3C64B308-0C04-11D2-B957-002018813989}#13.0#0"; "DMTCliFu.OCX"
...
Public Function CheckFido() As Boolean
    ...
    DmtFido.IDAnagrafica = frmNuovoOrdine.cdCliente.KeyFieldID
    DmtFido.TotDocumento = 0
    DmtFido.IDPagamento = frmNuovoOrdine.cboPagamento.CurrentID
