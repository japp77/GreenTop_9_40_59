...
Begin VB.Form frmLottoImballoKIT 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "LOTTO IMBALLO KIT SELEZIONATO"
   ClientHeight    =   6585
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   17535
   ...
   EndProperty
   Icon            =   "frmLottoImballoKIT.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6585
   ...
   Begin VB.TextBox txtInfo 
      ...
      MultiLine       =   -1  'True
      TabIndex        =   12
      Text            =   "frmLottoImballoKIT.frx":4781A
      Top             =   6000
      Width           =   14175
   End
   ...
   End
End
Attribute VB_Name = "frmLottoImballoKIT"
...
Private Sub Form_Load()
    ...
    Me.Caption = "LOTTO IMBALLO KIT SELEZIONATO (" & ARTICOLO_KIT_SEL & ")"
...
For I = 0 To rsKITLotti.Fields.Count - 1
    rsGriglia.Fields.Append rsKITLotti.Fields(I).Name, rsKITLotti.Fields(I).Type, rsKITLotti.Fields(I).DefinedSize, adFldIsNullable
    rsGrigliaSomma.Fields.Append rsKITLotti.Fields(I).Name, rsKITLotti.Fields(I).Type, rsKITLotti.Fields(I).DefinedSize, adFldIsNullable
Next
...
If Not ((rsKITLotti.EOF) And (rsKITLotti.BOF)) Then
    rsKITLotti.Filter = "IDRV_PODistintaBaseRighe=" & LINK_KIT_SEL
    If Not ((rsKITLotti.EOF) And (rsKITLotti.BOF)) Then
        ...
        While Not rsKITLotti.EOF
            ...
            rsGrigliaSomma.AddNew
                For I = 0 To rsKITLotti.Fields.Count - 1
                    rsGriglia.Fields(rsKITLotti.Fields(I).Name).Value = rsKITLotti.Fields(I).Value
                    rsGrigliaSomma.Fields(rsKITLotti.Fields(I).Name).Value = rsKITLotti.Fields(I).Value
                Next
            rsGriglia.Update
            rsGrigliaSomma.Update
        rsKITLotti.MoveNext
...
Me.txtQtaDaEvadere.Value = QUANTITA_KIT_SEL
