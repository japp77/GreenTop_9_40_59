VERSION 5.00
Begin VB.Form frmOraArrivoMerceQ 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ora lavorazione merce"
   ClientHeight    =   2070
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   4530
   Icon            =   "frmOraArrivoMerceQ.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2070
   ...
   End
End
Attribute VB_Name = "frmOraArrivoMerceQ"
...
End If
frmMain.txtOraLav_Q.Text = Ora & "." & Minuti & "." & Secondi
...
ArrayOrario = Split(frmMain.txtOraLav_Q.Text, ".")
