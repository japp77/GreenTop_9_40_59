         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Begin VB.CommandButton cmdSaveAs 
                  ...
                  Width           =   915
               End
               Begin DMTDataCmb.DMTCombo cboTipoStruttura 
                  Height          =   315
                  Left            =   120
                  TabIndex        =   7
                  Top             =   1920
               ...
               Begin VB.TextBox txtNomeSocio 
                  ...
                  Width           =   2295
               End
               Begin VB.TextBox txtCodiceSerra 
                  Height          =   315
                  Left            =   135
                  TabIndex        =   2
                  Top             =   1200
                  Width           =   1695
               End
               Begin VB.TextBox txtDescrizioneSerra 
                  Height          =   315
                  Left            =   1920
                  TabIndex        =   3
                  Top             =   1200
               ...
               Begin DmtCodDescCtl.DmtCodDesc CDSocio 
                  ...
                  BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  MenuFunctions   =   $"frmMain.frx":47A8A
                  BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
                  ...
                  Enabled         =   0   'False
               End
               Begin DMTEDITNUMLib.dmtNumber txtLunghezza 
                  Height          =   315
                  Left            =   6600
                  TabIndex        =   10
                  Top             =   1920
                  ...
                  AllowEmpty      =   0   'False
               End
               Begin DMTEDITNUMLib.dmtNumber txtLarghezza 
                  Height          =   315
                  Left            =   8040
                  TabIndex        =   11
                  Top             =   1920
            ...
            Begin TabDlg.SSTab SSTab1 
               ...
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               TabCaption(0)   =   "Particelle"
               TabPicture(0)   =   "frmMain.frx":47AE4
               Tab(0).ControlEnabled=   -1  'True
               Tab(0).Control(0)=   "Label2(5)"
               ...
               Tab(0).Control(8)=   "Label2(6)"
               Tab(0).Control(8).Enabled=   0   'False
               Tab(0).Control(9)=   "Label2(7)"
               Tab(0).Control(9).Enabled=   0   'False
               Tab(0).Control(10)=   "Label2(8)"
               Tab(0).Control(10).Enabled=   0   'False
               Tab(0).Control(11)=   "Label2(9)"
               Tab(0).Control(11).Enabled=   0   'False
               Tab(0).Control(12)=   "Label1(10)"
               Tab(0).Control(12).Enabled=   0   'False
               Tab(0).Control(13)=   "Label1(11)"
               Tab(0).Control(13).Enabled=   0   'False
               Tab(0).Control(14)=   "txtSuperficieParticellaMQ"
               Tab(0).Control(14).Enabled=   0   'False
               Tab(0).Control(15)=   "Griglia"
               Tab(0).Control(15).Enabled=   0   'False
               Tab(0).Control(16)=   "cmdElimina_Quadratura"
               Tab(0).Control(16).Enabled=   0   'False
               Tab(0).Control(17)=   "cmdSalva_Quadratura"
               Tab(0).Control(17).Enabled=   0   'False
               Tab(0).Control(18)=   "cmdNuovo_Quadratura"
               Tab(0).Control(18).Enabled=   0   'False
               Tab(0).Control(19)=   "txtSubPerticella"
               Tab(0).Control(19).Enabled=   0   'False
               Tab(0).Control(20)=   "txtFoglioCatastale"
               Tab(0).Control(20).Enabled=   0   'False
               Tab(0).Control(21)=   "txtMappaCatastale"
               Tab(0).Control(21).Enabled=   0   'False
               Tab(0).Control(22)=   "txtParticellaCatastale"
               Tab(0).Control(22).Enabled=   0   'False
               Tab(0).Control(23)=   "txtSuperficieParticellaHA"
               Tab(0).Control(23).Enabled=   0   'False
               Tab(0).Control(24)=   "txtIdentificativo"
               Tab(0).Control(24).Enabled=   0   'False
               Tab(0).Control(25)=   "txtTerreno"
               Tab(0).Control(25).Enabled=   0   'False
               Tab(0).Control(26)=   "txtIndirizzo"
               Tab(0).Control(26).Enabled=   0   'False
               Tab(0).Control(27)=   "txtComune"
               Tab(0).Control(27).Enabled=   0   'False
               Tab(0).Control(28)=   "txtProvincia"
               Tab(0).Control(28).Enabled=   0   'False
               Tab(0).Control(29)=   "txtCap"
               Tab(0).Control(29).Enabled=   0   'False
               Tab(0).Control(30)=   "Text2"
               Tab(0).Control(30).Enabled=   0   'False
               Tab(0).Control(31)=   "Text3"
               ...
               Begin VB.TextBox txtTerreno 
                  ...
                  Width           =   2415
               End
               Begin DMTEDITNUMLib.dmtNumber txtIdentificativo 
                  Height          =   285
                  Left            =   120
                  TabIndex        =   13
                  Top             =   540
                  ...
                  Appearance      =   1
               End
               Begin VB.TextBox txtSuperficieParticellaHA 
                  Height          =   315
                  Left            =   7440
                  Locked          =   -1  'True
                  TabIndex        =   19
               ...
               End
               Begin DMTEDITNUMLib.dmtNumber txtSuperficieParticellaMQ 
                  Height          =   315
                  Left            =   5760
                  TabIndex        =   18
                  Top             =   540
...
Private LINK_RIGA_PARTICELLA_TERRENO As Long
Private W_IDSERRA As Long
...
If Me.CDSocio.KeyFieldID = 0 Then
    MsgBox "Inserire il socio", vbInformation, "Inserimento dati"
    Me.CDSocio.SetFocus
    PermissionToSave = False
    Exit Function
End If
''''''''Codice serra'''''''''''''''''''''''''''''''''''''''''''''''''''''''
If Len(Me.txtCodiceSerra.Text) <= 0 Then
    MsgBox "Inserire il codice serra", vbInformation, "Inserimento dati"
    PermissionToSave = False
    Me.txtCodiceSerra.SetFocus
    Exit Function
End If
If Mid(Me.txtCodiceSerra.Text, 1, 1) = "0" Then
    MsgBox "Il codice della serra non può iniziare con il numero 0 (zero)", vbCritical, TheApp.FunctionName
    Me.txtCodiceSerra.SetFocus
    PermissionToSave = False
    Exit Function
End If

''''''''Controllo esistenza socio'''''''''''''''''''''''''''''''''''''''''''
If m_Document(m_Document.PrimaryKey).Value <= 0 Then
    sSQL = "SELECT * FROM RV_PO01_Serra "
    sSQL = sSQL & "WHERE Codice=" & fnNormString(Me.txtCodiceSerra.Text)
    ...
    If rs.EOF = False Then
        ...
        MsgBox "Codice serra presente per il socio inserito", vbInformation, "Inserimento dati"
        PermissionToSave = False
        Exit Function
    End If
End If
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtCodiceSerra
    Field.Name = "Codice"
    Field.Visible = True
    Me.txtCodiceSerra.Tag = Field.Name
    m_FormFields.Add Field
    
    'Descrizione serra
    Set Field = New FormField
    Set Field.Control = Me.txtDescrizioneSerra
    Field.Name = "Descrizione"
    Field.Visible = True
    Me.txtDescrizioneSerra.Tag = Field.Name
    m_FormFields.Add Field
    ...
    'Struttura
    Set Field = New FormField
    Set Field.Control = Me.cboTipoStruttura
    Field.Name = "IDRV_PO01_Struttura"
    Field.Visible = True
    Me.cboTipoStruttura.Tag = Field.Name
    m_FormFields.Add Field

    'Lunghezza
    Set Field = New FormField
    Set Field.Control = Me.txtLunghezza
    Field.Name = "Lunghezza"
    Field.Visible = True
    Me.txtLunghezza.Tag = Field.Name
    m_FormFields.Add Field

    'Larghezza
    Set Field = New FormField
    Set Field.Control = Me.txtLarghezza
    Field.Name = "Larghezza"
    Field.Visible = True
    Me.txtLarghezza.Tag = Field.Name
    m_FormFields.Add Field

    'Dismessa
    Set Field = New FormField
    Set Field.Control = Me.chkDismessa
    Field.Name = "Dismessa"
    Field.Visible = True
    Me.chkDismessa.Tag = Field.Name
    m_FormFields.Add Field
    
    'Annotazioni
    Set Field = New FormField
    Set Field.Control = Me.txtNote
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("Anagrafica", "Socio", m_DocType.TableName, False, False, False, dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("CodiceSocio", "Codice socio", m_DocType.TableName, False, False, False, dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("RV_POIDFeedentity", "Identificativo Feed", m_DocType.TableName, False, False, , dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("IDRV_PO01_Struttura", "Struttura", m_DocType.TableName, , , , dgCondTypeComboDB)
        Cond.RecordSource = "SELECT * FROM RV_PO01_Struttura"
        Cond.DisplayField = "Struttura"
        Cond.KeyField = "IDRV_PO01_Struttura"
    Set Cond = BrwMain.Conditions.Add("Dismessa", "Dismessa", m_DocType.TableName, False, False, False, dgCondTypeBoolean)
...
'SETTARE LE GRIGLIE DEI SOTTODOCUMENTI
    ...
    '-------------------------------------------------------------------------------
    'Tipo struttura
    With Me.cboTipoStruttura
        Set .Database = m_App.Database.Connection
        .AddFieldKey "IDRV_PO01_Struttura"
        .DisplayField = "Struttura"
        .SQL = "SELECT * FROM RV_PO01_Struttura ORDER BY Struttura"
        .Fill
    End With
        ...
        If Not Field.PrimaryKey Then
            If FieldPresent(Field.Name) Then
                ...
                Select Case TypeName(m_FormFields(Field.Name).Control)
                    Case "TextBox"
                        Field.Value = Trim(m_FormFields(Field.Name).Control.Text)
                    Case "DMTCombo"
...
Private Sub OnDelete()
    ...
    gResource.CustomStrings.Clear
    sToRemove = "Serra " & Trim(m_Document.Fields(CAMPO_PER_CAPTION).Value)
    ...
    If fnMsgQuestion(gResource.GetCustomizedMessage(MESS_QUERYREMOVE), m_App.FunctionName) = vbYes Then
        ...
        'Cancellazione
        If ControlloSerraSchema(fnNotNullN(m_Document(m_Document.PrimaryKey).Value)) = False Then
            DELETE_RIGHE fnNotNullN(m_Document(m_Document.PrimaryKey).Value)
            m_Document.DeleteDocument

        Else
            MsgBox "La serra risulta configurata in uno o più schemi", vbInformation, "Impossibile eliminare)"
        End If
...
Private Sub cboTipoStruttura_Click()
    If Not (BrwMain.Visible) Then Change
End Sub



Private Sub chkDismessa_Click()
If Not (BrwMain.Visible) Then Change
End Sub
...
If Me.txtIdentificativo.Value = 0 Then Exit Sub

sSQL = "DELETE FROM RV_PO01_SerraRighe "
sSQL = sSQL & "WHERE IDRV_PO01_SerraRighe=" & Me.txtIdentificativo.Value

Cn.Execute sSQL

fncGrigliaParticella

CALCOLA_SUPERFICIE_SERRA fnNotNullN(m_Document(m_Document.PrimaryKey).Value)
...
Dim sSQL As String
    ...
    'se non è ancora stato salvato il documento non si può procedere con una nuova riga(controllo su primary key)
    If fnNotNullN(m_Document(m_Document.PrimaryKey).Value) < 0 Then
        MsgBox "Attenzione, per poter procere salvare prima il documento", vbInformation
        Exit Sub
    End If

    LINK_SERRA_SOCIO = fnNotNullN(m_Document(m_Document.PrimaryKey).Value)
    
    frmParticelle.Show vbModal
    
    If RIPORTA_DATI_PARTICELLA = True Then
        ...
        rsNew.Open "RV_PO01_SerraRighe", Cn.InternalConnection, adOpenKeyset, adLockPessimistic
        
        While Not rs.EOF
            rsNew.AddNew
                rsNew!IDRV_PO01_SerraRighe = fnGetNewKey("RV_PO01_SerraRighe", "IDRV_PO01_SerraRighe")
                rsNew!IDRV_PO01_Serra = fnNotNullN(m_Document(m_Document.PrimaryKey).Value)
...
'se non è ancora stato salvato il documento non si può procedere con una nuova riga(controllo su primary key)
If fnNotNullN(m_Document(m_Document.PrimaryKey).Value) < 0 Then
    MsgBox "Attenzione, per poter procedere salvare prima il documento", vbInformation
    Exit Sub
End If
...
If Me.txtIdentificativo.Value > 0 Then
    ...
    If Not rs.EOF Then
        rs!DimensioneMQ = Me.txtSuperficieParticellaMQ.Value
        rs!DimensioneHA = Me.txtSuperficieParticellaHA.Text
        rs!GuidID = GetGUID
        rs.Update
    End If
...
'se non sono posizionato su nessun record nn posso fare la copia (test eseguito sul socio)
    If fnNotNullN(Val(CDSocio.Code)) = 0 Then
        MsgBox "Attenzione, per poter eseguire la duplicazione è necessario prima scegliere una serra/appezzamento", vbInformation
        Exit Sub
    End If
    

    W_IDSERRA = m_Document(m_Document.PrimaryKey).Value

'Creazione buffers vuoti
    NewRecord
    
'Reperimento dati generali della serra precedente
    If GET_DATI_GENERALI_SERRA = 1 Then
       MsgBox "Errore nel reperimento dati nel record di origine", vbInformation
       Exit Sub
    End If
  
'Salvataggio nuovi dati di testa nuova serra
    OnSave
    
'Salvataggio righe particelle su cui insiste la serra
    If GET_PARTICELLE_SERRA = 1 Then
       MsgBox "Errore nel reperimento dati delle particelle", vbInformation
       Exit Sub
    End If
    
    CALCOLA_SUPERFICIE_SERRA W_IDSERRA
    
    OnSave
  
End Sub

Private Function GET_DATI_GENERALI_SERRA() As Boolean
    Dim sSQL  As String
    Dim rs As DmtOleDbLib.adoResultset
    
    GET_DATI_GENERALI_SERRA = 1

    sSQL = "SELECT * FROM RV_PO01_Serra "
    sSQL = sSQL & "WHERE IDRV_PO01_Serra=" & W_IDSERRA
        
    Set rs = Cn.OpenResultset(sSQL)
        
    While Not rs.EOF = True
        GET_DATI_GENERALI_SERRA = 0
        CDSocio.Load fnNotNullN(rs!idsocio)
        txtCodiceSerra.Text = "Copy_" & fnNotNull(rs!Codice)
        txtDescrizioneSerra.Text = fnNotNull(rs!Descrizione)
        txtSuperficieMQ.Value = fnNotNullN(rs!DimensioneMQ)
        txtSuperficieHA.Text = fnNotNull(rs!DimensioneHA)
        cboTipoStruttura.WriteOn fnNotNullN(rs!IDRV_PO01_Struttura)
        Me.txtLunghezza.Value = fnNotNullN(rs!Lunghezza)
        Me.txtLarghezza.Value = fnNotNullN(rs!Larghezza)
       rs.MoveNext
    Wend
...
Private Function GET_PARTICELLE_SERRA() As Boolean
Dim rsNew As ADODB.Recordset
Dim rs As DmtOleDbLib.adoResultset
Dim sSQL As String
    
    If fnNotNullN(m_Document(m_Document.PrimaryKey).Value) = 0 Then Exit Function
...
Private Sub Griglia_Reposition(ByVal AllColumns As DmtGridCtl.dgColumns)
    Me.txtIdentificativo.Value = fnNotNullN(Me.Griglia("IDRV_PO01_SerraRighe").Value)
    Me.txtMappaCatastale.Text = fnNotNull(Me.Griglia("MappaCatastale").Value)
    Me.txtFoglioCatastale.Text = fnNotNull(Me.Griglia("FoglioCatastale").Value)
    Me.txtParticellaCatastale.Text = fnNotNull(Me.Griglia("ParticellaCatastale").Value)
    Me.txtSubPerticella.Text = fnNotNull(Me.Griglia("SubCatastale").Value)
    Me.txtSuperficieParticellaMQ.Value = fnNotNullN(Me.Griglia("DimensioneMQ").Value)
    Me.txtSuperficieParticellaHA.Text = fnNotNull(Me.Griglia("DimensioneHA").Value)
    Me.txtTerreno.Text = fnNotNull(Me.Griglia("Terreno").Value)
    Me.txtIndirizzo.Text = fnNotNull(Me.Griglia("Indirizzo").Value)
    Me.txtComune.Text = fnNotNull(Me.Griglia("Comune").Value)
    Me.txtProvincia.Text = fnNotNull(Me.Griglia("Provincia").Value)
    Me.txtCap.Text = fnNotNull(Me.Griglia("Cap").Value)
    Me.Text2.Text = fnNotNull(Me.Griglia("RV_POIDFeedentity").Value)
    Me.Text3.Text = fnNotNull(Me.Griglia("RV_POIDFeedentityTerreno").Value)
End Sub
...
Private Sub txtCodiceSerra_Change()
If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtDescrizioneSerra_Change()
If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtLarghezza_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtLunghezza_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
...
CALCOLA_SUPERFICIE_HA
End Sub

Private Sub CALCOLA_SUPERFICIE_HA()
...
Private Sub GET_SOCIO()
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

sSQL = "SELECT IDSocioRiferimento, Anagrafica, Nome FROM RV_PO01_ParametriFiliale WHERE ("
sSQL = sSQL & "(IDFiliale=" & m_App.Branch & "))"
...
If rs.EOF Then
    Me.CDSocio.Load 0
Else
    Me.CDSocio.Load fnNotNullN(rs!IDSocioRiferimento)
...
End Sub
Private Function ControlloSerraSchema(IDSerra As Long) As Boolean
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
    sSQL = "SELECT * FROM RV_PO01_SettoreSerra "
    sSQL = sSQL & "WHERE IDRV_PO01_Serra=" & IDSerra
    
    Set rs = Cn.OpenResultset(sSQL)
    
    If rs.EOF Then
        ControlloSerraSchema = False
    Else
        ControlloSerraSchema = True
    End If
...
Private Sub fncGrigliaParticella()
On Error Resume Next
Dim sSQL As String
Dim OLDCursor As Long
Dim cl As dgColumnHeader
Dim LINK_SERRA As Long


    LINK_SERRA = fnNotNullN(m_Document(m_Document.PrimaryKey).Value)
    If Err.Number > 0 Then
        LINK_SERRA = 0
    End If
    
    sSQL = "SELECT RV_PO01_SerraRighe.IDRV_PO01_SerraRighe, RV_PO01_SerraRighe.IDRV_PO01_Serra, RV_PO01_SerraRighe.IDRV_PO01_TerrenoRighe, "
    sSQL = sSQL & "RV_PO01_SerraRighe.DimensioneMQ, RV_PO01_SerraRighe.DimensioneHA,"
    sSQL = sSQL & "RV_PO01_TerrenoRighe.FoglioCatastale, RV_PO01_TerrenoRighe.MappaCatastale, RV_PO01_TerrenoRighe.ParticellaCatastale,"
    ...
    sSQL = sSQL & "Comune.Comune , Provincia.Provincia, RV_PO01_TerrenoRighe.RV_POIDFeedentity, "
    sSQL = sSQL & "RV_PO01_TerrenoTesta.RV_POIDFeedentity AS RV_POIDFeedentityTerreno, RV_PO01_TerrenoRighe.Annullato  "
    ...
    sSQL = sSQL & "RV_PO01_TerrenoTesta.IDRV_PO01_TerrenoTesta = RV_PO01_TerrenoRighe.IDRV_PO01_TerrenoTesta RIGHT OUTER JOIN "
    sSQL = sSQL & "RV_PO01_SerraRighe ON RV_PO01_TerrenoRighe.IDRV_PO01_TerrenoRighe = RV_PO01_SerraRighe.IDRV_PO01_TerrenoRighe "
    sSQL = sSQL & "WHERE RV_PO01_SerraRighe.IDRV_PO01_Serra=" & LINK_SERRA
    ...
    Cn.CursorLocation = 3
        ...
        With Me.Griglia
            ...
            .ColumnsHeader.Clear
                    .ColumnsHeader.Add "IDRV_PO01_SerraRighe", "IDRV_PO01_SerraRighe", dgNumeric, False, 800, dgAlignleft
                    .ColumnsHeader.Add "IDRV_PO01_Serra", "IDRV_PO01_Serra", dgNumeric, False, 800, dgAlignleft
                    .ColumnsHeader.Add "IDRV_PO01_TerrenoRighe", "IDRV_PO01_TerrenoRighe", dgNumeric, False, 800, dgAlignleft
                    ...
                    .ColumnsHeader.Add "ParticellaCatastale", "Particella", dgchar, True, 1000, dgAlignleft
                    .ColumnsHeader.Add "SubCatastale", "Sub", dgchar, True, 1000, dgAlignleft
                    Set cl = .ColumnsHeader.Add("DimensioneMQ", "Superficie M.q.", dgDouble, True, 2000, dgAlignRight)
                        cl.FormatOptions.FormatNumericRegionalSettings = False
                        cl.FormatOptions.UseFormatControlSettings = False
                        cl.FormatOptions.FormatNumericDecSep = ","
                        cl.FormatOptions.FormatNumericDecimals = 2
                        cl.FormatOptions.FormatNumericThousandSep = "."
                    .ColumnsHeader.Add "DimensioneHA", "Superficie H.a.", dgchar, True, 2000, dgAlignleft
                    .ColumnsHeader.Add "Terreno", "Terreno", dgchar, True, 1000, dgAlignleft
                    .ColumnsHeader.Add "Indirizzo", "Indirizzo", dgchar, True, 1000, dgAlignleft
                    .ColumnsHeader.Add "Comune", "Comune", dgchar, True, 1000, dgAlignleft
                    .ColumnsHeader.Add "Provincia", "Provincia", dgchar, True, 1000, dgAlignleft
                    .ColumnsHeader.Add "Cap", "Cap", dgchar, True, 1000, dgAlignleft
                    .ColumnsHeader.Add "RV_POIDFeedentity", "ID Feed", dgchar, True, 1000, dgAlignleft
                    .ColumnsHeader.Add "RV_POIDFeedentityTerreno", "IDTerreno Feed", dgchar, True, 1000, dgAlignleft
                    .ColumnsHeader.Add "Annullato", "Annullata", dgBoolean, False, 1000, dgAligncenter
...
ERR_fncGrigliaOrdine:
    MsgBox Err.Description, vbCritical, "Reperimento dati dati particelle"
End Sub

Private Sub txtSuperficieParticellaMQ_LostFocus()
Dim I As Integer
Dim X As String 'Stringa da formattare
Dim J As String '
Dim Ris As String
...
Dim Rimanenza As Integer
Dim Valore As Long
Valore = Me.txtSuperficieParticellaMQ.Value
...
For I = 1 To Len(X)
    ...
    End If
Next
Me.txtSuperficieParticellaHA.Text = J
End Sub

Private Sub CALCOLA_SUPERFICIE_SERRA(IDSerra As Long)
On Error GoTo ERR_CALCOLA_SUPERFICIE_SERRA
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

sSQL = "SELECT RV_PO01_SerraRighe.IDRV_PO01_Serra, SUM(RV_PO01_SerraRighe.DimensioneMQ) AS SommaMQ, RV_PO01_TerrenoRighe.Annullato "
sSQL = sSQL & "FROM RV_PO01_SerraRighe INNER JOIN "
sSQL = sSQL & "RV_PO01_TerrenoRighe ON RV_PO01_SerraRighe.IDRV_PO01_TerrenoRighe = RV_PO01_TerrenoRighe.IDRV_PO01_TerrenoRighe "
sSQL = sSQL & "GROUP BY RV_PO01_SerraRighe.IDRV_PO01_Serra, RV_PO01_TerrenoRighe.Annullato "
sSQL = sSQL & "Having (RV_PO01_SerraRighe.IDRV_PO01_Serra = " & IDSerra & ") And (RV_PO01_TerrenoRighe.Annullato = 0)"
   
Set rs = Cn.OpenResultset(sSQL)
If rs.EOF Then
    txtSuperficieMQ.Value = 0
Else
    txtSuperficieMQ.Value = fnNotNullN(rs!SommaMQ)
End If
...
CALCOLA_SUPERFICIE_HA
Exit Sub
ERR_CALCOLA_SUPERFICIE_SERRA:
    MsgBox Err.Description, vbCritical, "CALCOLA_SUPERFICIE_SERRA"
End Sub




Private Sub DELETE_RIGHE(IDSerra As Long)
Dim sSQL As String
...
Cn.Execute sSQL
End Sub
Private Function GET_ESISTENZA_CODICE(IDAnagraficaSocio As Long, CodiceSerra As String) As Boolean
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

sSQL = "SELECT IDRV_PO01_Serra "
sSQL = sSQL & "FROM RV_PO01_Serra "
sSQL = sSQL & "WHERE IDAnagraficaSocio=" & IDAnagraficaSocio
sSQL = sSQL & " AND Codice=" & fnNormString(CodiceSerra)

Set rs = Cn.OpenResultset(sSQL)

If rs.EOF Then
    GET_ESISTENZA_CODICE = False
Else
    GET_ESISTENZA_CODICE = True
End If
