         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Begin VB.Frame Frame3 
                  ...
                  Top             =   1080
                  Width           =   2415
                  Begin DMTEDITNUMLib.dmtNumber txtFineMatGiorno 
                     Height          =   315
                     Left            =   120
                     TabIndex        =   7
                     Top             =   600
                     ...
                     AllowEmpty      =   0   'False
                  End
                  Begin DMTEDITNUMLib.dmtNumber txtFineMatMese 
                     Height          =   315
                     Left            =   1320
                     TabIndex        =   8
                     Top             =   600
               ...
               Begin VB.Frame Frame2 
                  ...
                  Top             =   1080
                  Width           =   2415
                  Begin DMTEDITNUMLib.dmtNumber txtInizioMatGiorno 
                     Height          =   315
                     Left            =   120
                     TabIndex        =   5
                     Top             =   600
                     ...
                     AllowEmpty      =   0   'False
                  End
                  Begin DMTEDITNUMLib.dmtNumber txtInizioMatMese 
                     Height          =   315
                     Left            =   1320
                     TabIndex        =   6
                     Top             =   600
               ...
               Begin DMTDataCmb.DMTCombo CboFamigliaProdotti 
                  ...
                  EndProperty
               End
               Begin VB.TextBox txtTipoVarieta 
                  Height          =   315
                  Left            =   2400
                  TabIndex        =   1
                  Top             =   615
                  Width           =   4605
               End
               Begin DMTDataCmb.DMTCombo cboRaggr 
                  Height          =   315
                  Left            =   10200
                  TabIndex        =   3
                  Top             =   600
               ...
               Begin VB.Label Label2 
                  ...
                  Width           =   2100
               End
               Begin VB.Label LblFamigliaProdotti 
...
Private Const CAMPO_PER_CAPTION = "Varieta"
...
Private Function PermissionToSave() As Boolean
    ...
    If Me.CboFamigliaProdotti.CurrentID = 0 Then
        MsgBox "Selezionare una famiglia prodotti", vbCritical, TheApp.FunctionName
        PermissionToSave = False
        Exit Function
    End If
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtTipoVarieta
    Field.Name = "Varieta"
    Field.Visible = True
    Me.txtTipoVarieta.Tag = Field.Name
    ...
    'GiornoInizioMat
    Set Field = New FormField
    Set Field.Control = Me.txtInizioMatGiorno
    Field.Name = "GiornoInizioMat"
    Field.Visible = True
    Me.txtInizioMatGiorno.Tag = Field.Name
    m_FormFields.Add Field

    'MeseInizioMat
    Set Field = New FormField
    Set Field.Control = Me.txtInizioMatMese
    Field.Name = "MeseInizioMat"
    Field.Visible = True
    Me.txtInizioMatMese.Tag = Field.Name
    m_FormFields.Add Field
    
    'GiornoFineMat
    Set Field = New FormField
    Set Field.Control = Me.txtFineMatGiorno
    Field.Name = "GiornoFineMat"
    Field.Visible = True
    Me.txtFineMatGiorno.Tag = Field.Name
    m_FormFields.Add Field

    'MeseFineMat
    Set Field = New FormField
    Set Field.Control = Me.txtFineMatMese
    Field.Name = "MeseFineMat"
    Field.Visible = True
    Me.txtFineMatMese.Tag = Field.Name
    m_FormFields.Add Field
    ...
    'Identificativo RaggruppamentoVarieta
    Set Field = New FormField
    Set Field.Control = Me.cboRaggr
    Field.Name = "IDRV_PO01_RaggruppamentoVarieta"
    Field.Visible = True
    Me.cboRaggr.Tag = Field.Name
    m_FormFields.Add Field
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("Varieta", "Varietà", m_DocType.TableName, False, False, False, dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("CodiceImEx", "Codice Import/Export", m_DocType.TableName, False, False, False, dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("IDRV_PO01_FamigliaProdotti", "Famiglia Prodotti", m_DocType.TableName, False, False, , dgCondTypeComboDB)
    ...
    Set Cond = BrwMain.Conditions.Add("IDRV_PO01_RaggruppamentoVarieta", "Raggruppamento", m_DocType.TableName, False, False, , dgCondTypeComboDB)
        Cond.RecordSource = "SELECT * FROM RV_PO01_RaggruppamentoVarieta ORDER BY RaggruppamentoVarieta"
        Cond.DisplayField = "RaggruppamentoVarieta"
        Cond.KeyField = "IDRV_PO01_RaggruppamentoVarieta"
End Sub
...
'SETTARE LE GRIGLIE DEI SOTTODOCUMENTI
    ...
    With Me.cboRaggr
        Set .Database = m_App.Database.Connection
        .AddFieldKey "IDRV_PO01_RaggruppamentoVarieta"
        .DisplayField = "RaggruppamentoVarieta"
        .SQL = "SELECT * FROM RV_PO01_RaggruppamentoVarieta ORDER BY RaggruppamentoVarieta"
        .Fill
    End With
...
On Error GoTo ERR_OnSave
    ...
    If Me.CboFamigliaProdotti.CurrentID > 0 Then
        sSQL = "UPDATE RV_PO01_FamigliaProdotti SET "
...
Private Sub LbTipoVarieta_Click()
...
Private Sub txtFineMatGiorno_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtFineMatMese_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtInizioMatGiorno_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtInizioMatMese_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
...
Private Sub txtTipoVarieta_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
'**+
'Nome: SendDocument
